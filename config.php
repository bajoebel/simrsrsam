...
defined('ONLINE_CALL_BACK') or define('ONLINE_CALL_BACK', 'https://rsam-bkt.sumbarprov.go.id/wsjkn/');
...
// defined('WSJKNMOBILE') or define('WSJKNMOBILE', 'http://localhost/wsonline/');
