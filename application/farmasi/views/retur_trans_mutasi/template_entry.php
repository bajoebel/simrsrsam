...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#kembali').click(function() {
            var a = "<?php echo $kLok ?>";
            window.location.href = "<?php echo base_url() . 'farmasi.php/retur_trans_mutasi/goForm?kLok=' ?>" + a;
        });
        ...
        $('#xKDMT').keyup(function(ev) {
            ...
            if (event == 13) {
                ...
                var b = "<?php echo $kLok ?>";
                $.ajax({
                    url: "<?php echo base_url() . 'farmasi.php/retur_trans_mutasi/getMutasi' ?>",
                    type: "POST",
                    data: {
                        KDMT: a,
                        LOKASI_ASAL: b
        ...
        $('#btnKeywordCariObat').click(function() {
            ...
            var c = "<?php echo $kLok ?>";
            $.ajax({
                url: "<?php echo base_url() . 'farmasi.php/retur_trans_mutasi/getObat' ?>",
                type: "POST",
                data: {
                    KDMT: a,
                    keyword: b,
        ...
        $("#simpanTemp").click(function() {
            ...
            if (formItems['KDBRG'] == "") {
                ...
                $.ajax({
                    url: "<?php echo base_url() . 'farmasi.php/retur_trans_mutasi/simpanTemp' ?>",
                    type: "POST",
                    data: formItems,
                    dataType: "JSON",
                    success: function(data) {
        ...
        $('#simpan').click(function() {
            ...
            if (formdata['KDMT'] == "") {
                ...
                $.ajax({
                    url: "<?php echo base_url() . 'farmasi.php/retur_trans_mutasi/simpan' ?>",
                    type: "POST",
                    data: formdata,
                    dataType: "JSON",
                    beforeSend: function() {
    ...
    function getTemp() {
        $.ajax({
            url: "<?php echo base_url() . 'farmasi.php/retur_trans_mutasi/getTemp' ?>",
            beforeSend: function() {
    ...
    function emptyTemp() {
        $.ajax({
            url: "<?php echo base_url() . 'farmasi.php/retur_trans_mutasi/emptyTemp' ?>",
            success: function(data) {
                getTemp();
            },
            error: function(jqXHR, ajaxOption, errorThrown) {
    ...
    function setMutasi(a) {
        $.ajax({
            url: "<?php echo base_url() . 'farmasi.php/retur_trans_mutasi/getArrMutasi' ?>",
            type: "POST",
            data: {
                KDMT: a
            },
    ...
    function hapusTemp(a) {
        ...
        if (x) {
            $.ajax({
                url: "<?php echo base_url() . 'farmasi.php/retur_trans_mutasi/hapusTemp' ?>",
                type: "POST",
                data: {
                    IDX: a
                },
