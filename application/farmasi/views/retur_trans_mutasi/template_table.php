...
$(document).ready(function () { 
    ...
    $('#btnKembali').click(function(){
        var url = '<?php echo base_url().'farmasi.php/retur_trans_mutasi' ?>';
        window.location.href = url;        
    });
    $('#btnTambah').click(function(){
        var a = "<?php echo $kLok ?>";
        var url = "<?php echo base_url().'farmasi.php/retur_trans_mutasi/tambah?kLok=' ?>"+a;
        window.location.href = url;        
    });
    ...
    $('#keyword').keypress(function(ev){
        ...
        if (keycode == '13') {
            ...
            var b = "<?php echo $kLok ?>";
            $.ajax({
                url         : "<?php echo base_url().'farmasi.php/retur_trans_mutasi/getView' ?>",
                type        : "POST",
                data        : {sLike:a,kLok:b},
                beforeSend  : function(){
...
function cetak(a){
    var url = '<?php echo base_url().'farmasi.php/retur_trans_mutasi/cetak?kode=' ?>'+a;
    openInNewTab(url);        
}
