...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#kembali').click(function() {
            var a = "<?php echo $kLok ?>";
            window.location.href = "<?php echo base_url() . 'farmasi.php/trans_pemakaian_bhp' ?>";
        });
        ...
        $('#btnKeywordCariObat').click(function() {
            ...
            var b = "<?php echo $kLok ?>";
            $.ajax({
                url: "<?php echo base_url() . 'farmasi.php/trans_pemakaian_bhp/getObat' ?>",
                type: "POST",
                data: {
                    keyword: a,
                    KDLOKASI: b
        ...
        $("#simpanTemp").click(function() {
            ...
            if (formItems['KDBRG'] == "") {
                ...
                $.ajax({
                    url: "<?php echo base_url() . 'farmasi.php/trans_pemakaian_bhp/simpanTemp' ?>",
                    type: "POST",
                    data: formItems,
                    dataType: "JSON",
                    success: function(data) {
        ...
        $('#simpan').click(function() {
            ...
            if (formdata['LOKASI_TUJUAN'] == "") {
                ...
                $.ajax({
                    url: "<?php echo base_url() . 'farmasi.php/trans_pemakaian_bhp/simpan' ?>",
                    type: "POST",
                    data: formdata,
                    dataType: "JSON",
                    beforeSend: function() {
    ...
    function getTemp() {
        $.ajax({
            url: "<?php echo base_url() . 'farmasi.php/trans_pemakaian_bhp/getTemp' ?>",
            beforeSend: function() {
    ...
    function emptyTemp() {
        $.ajax({
            url: "<?php echo base_url() . 'farmasi.php/trans_pemakaian_bhp/emptyTemp' ?>",
            success: function(data) {
                getTemp();
            },
            error: function(xhr, ajaxOption, thrownError) {
    ...
    function hapusTemp(a) {
        ...
        if (x) {
            $.ajax({
                url: "<?php echo base_url() . 'farmasi.php/trans_pemakaian_bhp/hapusTemp' ?>",
                type: "POST",
                data: {
                    IDX: a
                },
