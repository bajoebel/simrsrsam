...
$(document).ready(function () { 
    ...
    $('#btnKembali').click(function(){
        var url = '<?php echo base_url().'farmasi.php/trans_pemakaian_bhp' ?>';
        window.location.href = url;        
    });
    $('#btnTambah').click(function(){
        var a = "<?php echo $kLok ?>";
        var url = "<?php echo base_url().'farmasi.php/trans_pemakaian_bhp/tambah' ?>";
        window.location.href = url;        
    });
    ...
    $('#keyword').keypress(function(ev){
        ...
        if (keycode == '13') {
            ...
            var b = "<?php echo $kLok ?>";
            $.ajax({
                url         : "<?php echo base_url().'farmasi.php/trans_pemakaian_bhp/getView' ?>",
                type        : "POST",
                data        : {sLike:a,kLok:b},
                beforeSend  : function(){
...
function cetak(a){
    var url = '<?php echo base_url().'farmasi.php/trans_pemakaian_bhp/cetak?kode=' ?>'+a;
    openInNewTab(url);        
}
