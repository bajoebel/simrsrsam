...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#kembali').click(function() {
            var a = "<?php echo $kLok ?>";
            window.location.href = "<?php echo base_url() . 'farmasi.php/trans_penjualan' ?>";
        });
        ...
        $('#btnKeywordCariPasien').click(function() {
            ...
            $.ajax({
                url: "<?php echo base_url() . 'farmasi.php/trans_penjualan/getPasien' ?>",
                type: "POST",
                data: {
                    keyword: a
                },
                ...
                success: function(data) {
                    ...
                    $('tr.resultDat').each(function() {
                        var a = $(this).data('id');
                        $.ajax({
                            url: "<?php echo base_url() . 'farmasi.php/trans_penjualan/cekRetur' ?>",
                            type: "POST",
                            data: {
                                reg_unit: a
                            },
        ...
        $('#btnKeywordCariObat').click(function() {
            ...
            var b = "<?php echo $kLok ?>";
            $.ajax({
                url: "<?php echo base_url() . 'farmasi.php/trans_penjualan/getObat' ?>",
                type: "POST",
                data: {
                    keyword: a,
                    KDLOKASI: b
        ...
        $('#simpan').click(function() {
            ...
            if (formdata['REG_UNIT'] == "") {
                ...
                $.ajax({
                    url: "<?php echo base_url() . 'farmasi.php/trans_penjualan/simpan' ?>",
                    type: "POST",
                    data: formdata,
                    dataType: "JSON",
                    beforeSend: function() {
                    ...
                    success: function(data) {
                        if (data.code == 200) {
                            ...
                            kosongkanObjTemp();
                            getTemp();
                            window.open('<?php echo base_url() . 'farmasi.php/trans_penjualan/cetakTicket?kode=' ?>' + data.message + "&kLok=<?= $kLok ?>" + "&action=print");
                        } else {
                            alert(data.message);
                        }
                    },
    ...
    function getTemp() {
        $.ajax({
            url: "<?php echo base_url() . 'farmasi.php/trans_penjualan/getTemp' ?>",
            beforeSend: function() {
    ...
    function emptyTemp() {
        $.ajax({
            url: "<?php echo base_url() . 'farmasi.php/trans_penjualan/emptyTemp' ?>",
            success: function(data) {
                getTemp();
            },
            error: function(jqXHR, ajaxOption, errorThrown) {
    ...
    function getTotal() {
        $.ajax({
            url: "<?php echo base_url() . 'farmasi.php/trans_penjualan/getTotalTemp' ?>",
            dataType: "JSON",
            beforeSend: function() {
                $('#GRANDTOTAL').val("0");
            },
    ...
    function setPasien(a) {
        $.ajax({
            url: "<?php echo base_url() . 'farmasi.php/trans_penjualan/getPendaftaran' ?>",
            type: "POST",
            data: {
                reg_unit: a
            },
    ...
    function hapusTemp(a) {
        ...
        if (x) {
            $.ajax({
                url: "<?php echo base_url() . 'farmasi.php/trans_penjualan/hapusTemp' ?>",
                type: "POST",
                data: {
                    IDX: a
                },
    ...
    var base_url = "<?= base_url() . "farmasi.php/"; ?>";
</script>
