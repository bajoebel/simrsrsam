            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        ...
                        <!--a href="<?php //echo base_url() . "farmasi.php/trans_penjualan/cetakTicket?kode=" . $KDJL . "&kLok=" . $kLok . "&action=print" ?>" id="btnCetak" class="btn btn-default" target="_blank">
                            <i class="glyphicon glyphicon-print"></i> Cetak Semua</a-->
                        <a href="<?= base_url() . "farmasi.php/pemakaian_obat/cetakTicket?kode=" . $KDJL ?>" id="btnCetak" class="btn btn-default" target="_blank">
                            <i class="glyphicon glyphicon-print"></i> Cetak Semua</a>
                    </h3>
                    <div class="box-tools">
                    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#btnKembali').click(function() {
            var a = "<?php echo $kLok ?>";
            window.location.href = "<?php echo base_url() . 'farmasi.php/trans_penjualan/goForm?kLok=' ?>" + a;
        });
    ...
    function printETicket(a, b, c, d, e, f, g, h) {
        window.open('<?php echo base_url() . 'farmasi.php/trans_penjualan/eticket?nomr=' ?>' + a + '&nama=' + b + '&tgl=' + c + '&brg=' + d + '&ap=' + e + '&tgl_lahir=' + f + '&jml=' + g + '&satuan=' + h);
    }
    ...
    function setAP() {
        ...
        $.ajax({
            url: "<?php echo base_url() . 'farmasi.php/trans_penjualan/updateAP' ?>",
            type: "POST",
            data: formItems,
            dataType: "JSON",
