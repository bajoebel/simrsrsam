...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#btnTambah').click(function() {
            var url = '<?php echo base_url() . 'farmasi.php/obat/tambah/' ?>';
        ...
        $('#keyword').keypress(function(ev) {
            ...
            if (keycode == '13') {
                $.ajax({
                    url: "<?php echo base_url() . 'farmasi.php/obat/getView' ?>",
                    type: "POST",
                    data: {
                        sLike: $(this).val(),
    ...
    function edit(a) {
        var url = '<?php echo base_url() . 'farmasi.php/obat/tambah/' ?>' + a;
        window.location.href = url;
    }
    ...
    function hapus(a) {
        ...
        if (x) {
            $.ajax({
                url: "<?php echo base_url() . 'farmasi.php/obat/hapus' ?>",
                type: "POST",
                data: {
                    KDBRG: a,
                    <?= $this->security->get_csrf_token_name(); ?>: $('#csrf').val()
