...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#keyword').keypress(function(ev) {
            ...
            if (keycode == '13') {
                $.ajax({
                    url: "<?php echo base_url() . 'farmasi.php/kategori_barang/getView' ?>",
                    type: "POST",
                    data: {
                        sLike: $(this).val(),
    ...
    function hapus(a) {
        ...
        if (x) {
            $.ajax({
                url: "<?php echo base_url() . 'farmasi.php/kategori_barang/hapus' ?>",
                type: "POST",
                data: {
                    KDKTBRG: a,
                    <?= $this->security->get_csrf_token_name(); ?>: $('#csrf').val()
    ...
    function simpan() {
        ...
        if (a == "") {
            ...
            $.ajax({
                url: "<?php echo base_url() . 'farmasi.php/kategori_barang/simpan' ?>",
                type: "POST",
