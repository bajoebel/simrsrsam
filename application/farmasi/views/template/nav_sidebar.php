<section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree" id="menu">
        ...
        <li class="<?php echo $nav_1; ?>">
            <a href="<?php echo base_url() . 'farmasi.php/dashboard' ?>">
        ...
        <li class="treeview <?php echo $nav_2; ?>">
            ...
            <ul class="treeview-menu">
                <li><a href="<?php echo base_url() . 'farmasi.php/group_lokasi' ?>">
                        <i class="fa fa-circle-o text-red"></i>Group Lokasi</a></li>
                <li><a href="<?php echo base_url() . 'farmasi.php/satuan' ?>">
                        <i class="fa fa-circle-o text-red"></i>Satuan</a></li>
                <li><a href="<?php echo base_url() . 'farmasi.php/kategori_barang' ?>">
                        <i class="fa fa-circle-o text-red"></i>Kategori Barang</a></li>
                <li><a href="<?php echo base_url() . 'farmasi.php/jenis_barang' ?>">
        ...
        <?php if ($gudang > 0) { ?>
            <li class="treeview <?php echo $nav_5; ?>">
                ...
                <ul class="treeview-menu">
                    <li><a href="<?php echo base_url() . 'farmasi.php/trans_pembelian' ?>">
                            <i class="fa fa-circle-o text-red"></i>Pembelian</a></li>
                    <li><a href="<?php echo base_url() . 'farmasi.php/retur_trans_pembelian' ?>">
                            <i class="fa fa-circle-o text-red"></i>Retur Pembelian</a></li>
                    <li><a href="<?php echo base_url() . 'farmasi.php/barang_masuk_khusus' ?>">
                            <i class="fa fa-circle-o text-red"></i>Barang Pinjaman</a></li>
                    <li><a href="<?php echo base_url() . 'farmasi.php/retur_barang_masuk_khusus' ?>">
        ...
        <li class="treeview <?php echo $nav_6; ?>">
            ...
            <ul class="treeview-menu">
                <li><a href="<?php echo base_url() . 'farmasi.php/trans_mutasi' ?>">
                        <i class="fa fa-circle-o text-red"></i>Mutasi</a></li>
                <li><a href="<?php echo base_url() . 'farmasi.php/retur_trans_mutasi' ?>">
                        <i class="fa fa-circle-o text-red"></i>Retur Mutasi</a></li>
                <li><a href="<?php echo base_url() . 'farmasi.php/trans_pemakaian_bhp' ?>">

                        <i class="fa fa-circle-o text-red"></i>Pemakaian BHP</a></li>
                <li><a href="<?php echo base_url() . 'farmasi.php/retur_trans_pemakaian_bhp' ?>">
        ...
        <?php if ($all > 0) { ?>
            <li class="treeview <?php echo $nav_7; ?>">
                ...
                <ul class="treeview-menu">
                    <?php if ($apotik > 0) { ?>
                        <li><a href="<?php echo base_url() . 'farmasi.php/trans_penjualan' ?>">
                                <i class="fa fa-circle-o text-red"></i>Penjualan</a></li>
                        <li><a href="<?php echo base_url() . 'farmasi.php/retur_trans_penjualan' ?>">
                                <i class="fa fa-circle-o text-red"></i>Retur Penjualan</a></li>
                    <?php }
                    if ($gudang > 0) { ?>
                        <li><a href="<?php echo base_url() . 'farmasi.php/barang_keluar_khusus' ?>">
                                <i class="fa fa-circle-o text-red"></i>Pengembalian Barang</a></li>
                        <li><a href="<?php echo base_url() . 'farmasi.php/retur_barang_keluar_khusus' ?>">
                                <i class="fa fa-circle-o text-red"></i>Retur Pengembalian Barang</a></li>
                    <?php } ?>
                    <li><a href="<?php echo base_url() . 'farmasi.php/pemakaian_obat' ?>">
        ...
        <li class="treeview <?php echo $nav_8; ?>">
            ...
            <ul class="treeview-menu">
                <li><a href="<?php echo base_url() . 'farmasi.php/stok_rs' ?>">
                        <i class="fa fa-circle-o text-red"></i>Stok By Rumah Sakit</a></li>
                <li><a href="<?php echo base_url() . 'farmasi.php/stok_lokasi' ?>">
        ...
        <li class="treeview <?php echo $nav_9; ?>">
            ...
            <ul class="treeview-menu">
                <li><a href="<?php echo base_url() . 'farmasi.php/lap_stok_awal' ?>">
                        <i class="fa fa-circle-o text-red"></i>Stok Awal</a></li>
                <li><a href="<?php echo base_url() . 'farmasi.php/lap_kartu_stok' ?>">
                        <i class="fa fa-circle-o text-red"></i>Kartu Stok</a></li>
                <li><a href="<?php echo base_url() . 'farmasi.php/lap_koreksi_stok' ?>">
                        <i class="fa fa-circle-o text-red"></i>Koreksi Stok</a></li>
                <li><a href="<?php echo base_url() . 'farmasi.php/laporan_pembelian' ?>">
                        <i class="fa fa-circle-o text-red"></i>Pembelian</a></li>
                <li><a href="<?php echo base_url() . 'farmasi.php/laporan_retur_pembelian' ?>">
                        <i class="fa fa-circle-o text-red"></i>Retur Pembelian</a></li>
                <li><a href="<?php echo base_url() . 'farmasi.php/laporan_barang_pinjaman' ?>">
                        <i class="fa fa-circle-o text-red"></i>Barang Pinjaman</a></li>
                <li><a href="<?php echo base_url() . 'farmasi.php/laporan_retur_barang_pinjaman' ?>">
                        <i class="fa fa-circle-o text-red"></i>Retur Barang Pinjaman</a></li>
                <li><a href="<?php echo base_url() . 'farmasi.php/laporan_mutasi' ?>">
                        <i class="fa fa-circle-o text-red"></i>Mutasi</a></li>
                <li><a href="<?php echo base_url() . 'farmasi.php/laporan_mutasi/laporan_retur_mutasi' ?>">
                        <i class="fa fa-circle-o text-red"></i>Retur Mutasi</a></li>
                <li><a href="<?php echo base_url() . 'farmasi.php/laporan_pemakaian_bhp' ?>">
                        <i class="fa fa-circle-o text-red"></i>Pemakaian BHP</a></li>
                <li><a href="<?php echo base_url() . 'farmasi.php/laporan_pemakaian_bhp/laporan_retur_bhp' ?>">
                        <i class="fa fa-circle-o text-red"></i>Retur Pemakaian BHP</a></li>
                <li><a href="<?php echo base_url() . 'farmasi.php/laporan_penjualan' ?>">
                        <i class="fa fa-circle-o text-red"></i>Penjualan</a></li>
                <li><a href="<?php echo base_url() . 'farmasi.php/laporan_retur_penjualan' ?>">
                        <i class="fa fa-circle-o text-red"></i>Retur Penjualan</a></li>
                <li><a href="<?php echo base_url() . 'farmasi.php/laporan_pengembalian_barang' ?>">
                        <i class="fa fa-circle-o text-red"></i>Pengembalian Barang</a></li>
                <li><a href="<?php echo base_url() . 'farmasi.php/laporan_pengembalian_barang/laporan_retur_pengembalian_barang' ?>">
                        <i class="fa fa-circle-o text-red"></i>Retur Pengembalian Barang</a></li>
            </ul>
        </li>
    </ul>
