...
<body id="A4">
    ...
    <table width="100%" border="0" id="directPrint1">
        <tr>
            <td align="center">
                <a href="#" onclick="location.href='<?php echo base_url('mutasi_bhp') ?>'" class="btn">Kembali</a>
    ...
    <table width="100%" border="0">
        <tr>
            ...
            <td width="10px" align="center">:</td>
            <td><?php echo $NMLOKASI_ASAL ?></td>
        </tr>
        <tr>
            <td>Tgl Mutasi</td>
            <td align="center">:</td>
            <td><?php echo date('d-m-Y H:i',strtotime($DTMTBHP)) ?></td>
            <td>Lokasi Tujuan</td>
            <td align="center">:</td>
            <td><?php echo $NMLOKASI_TUJUAN ?></td>
        </tr>
    </table>
