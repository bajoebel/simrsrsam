...
<div id="content">
    <div id="content-header">
        ...
        <h1>Transaksi Mutasi BHP/BMHP</h1>
    </div>
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="left span4">
                    <button type="button" onclick="location.href='<?php echo base_url() ?>mutasi_bhp/tambah'" class="btn">
                ...
                <div id="searchTable" class="right span8">
                    <input type="text" class="" placeholder="Enter Lokasi Asal / Lokasi Tujuan ..." name="keywordText" id="keywordText"/>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var urlGet = "<?php echo base_url().'mutasi_bhp/getView' ?>";
        getTable();
        function getTable(){
            $.ajax({
                url : "<?php echo base_url().'mutasi_bhp/getView' ?>",
                type : "POST",
        ...
        $('#keywordFilter').change(function(){
            ...
            $.ajax({
                ...
                error : function(jqXHR,ajaxOption,errorThrown){console.log(jqXHR.responseText)}
            });            
        });
...
<script>
    ...
    function cetak(a){
        window.location.href = '<?php echo base_url().'mutasi_bhp/cetak?kode=' ?>'+a;
    }    
