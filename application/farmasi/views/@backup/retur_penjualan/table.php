        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="left span4">
                    <button type="button" onclick="location.href='<?php echo base_url() ?>retur_penjualan/tambah'" class="btn">
...
$(document).ready(function(){
    ...
    var urlGet = "<?php echo base_url().'retur_penjualan/getView' ?>";
    getTable();
    function getTable(){
        $.ajax({
            url         : "<?php echo base_url().'retur_penjualan/getView' ?>",
            beforeSend  : function(){
                $('tbody#getData').html("");
            },
...
<script>
    function cetak(a){
        window.location.href = '<?php echo base_url().'retur_penjualan/cetak?kode=' ?>'+a;
    } 
</script>
