        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="left span4">
                    <button type="button" onclick="location.href='<?php echo base_url() ?>data_penjualan/tambah'" class="btn">
                ...
                <div id="searchTable" class="right span8">
                    <input type="text" class="" placeholder="Enter No Faktur / Nama Customer ..." name="keywordText" id="keywordText"/>
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <table class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th width="100px">Waktu Rekam</th>
                                    <th width="70px">No Faktur</th>
                                    <th width="100px">Tgl Resep</th>
                                    <th>User</th>
...
$(document).ready(function(){
    ...
    var urlGet = "<?php echo base_url().'data_penjualan/getView' ?>";
    getTable();
    function getTable(){
        $.ajax({
            url : "<?php echo base_url().'data_penjualan/getView' ?>",
            type : "POST",
            data : {sFilter:10,sLike:""},
            beforeSend  : function(){
                $('tbody#getData').html("<tr><td colspan=10>Loading... please wait!</td></tr>");
            },
...
function cetak(a){
    window.open('<?php echo base_url().'data_penjualan/cetak?kode=' ?>'+a);
}   
function cetakTicket(a){
    window.open('<?php echo base_url().'data_penjualan/cetakTicket?kode=' ?>'+a);
}   
function edit(a){
    window.location.href = '<?php echo base_url().'data_penjualan/edit?kode=' ?>'+a;
} 
