...
class lap_stok_awal extends CI_Controller {
    ...
    public function index(){
        ...
        if($ses_state){
            ...
            $x['content'] = $this->load->view('lap_stok_awal/template_form',$y,true);
    ...
    function getView(){
        ...
        $config['base_url']    = base_url().'farmasi.php/lap_stok_awal/getView';
        ...
        $this->load->view('lap_stok_awal/getdata',$x);
    } 
}
