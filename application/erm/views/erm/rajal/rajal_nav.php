<div class="nav-tabs-custom">
    <ul class="nav nav-pills nav-stacked">
        ...
        <li class="active" onclick="getRiwayat(3,<?= $detail->idx ?>)"><a href="#tab_3" data-toggle="tab">Kajian Awal Keperawatan</a></li>
        <li><a href="#tab_4" data-toggle="tab">Kajian Awal Medis</a></li>
        <li><a href="#tab_5" data-toggle="tab">Perkembangan Pasien Terintegrasi</a></li>
