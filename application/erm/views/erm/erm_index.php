                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <div class='allow-scroll1'>
                                                                            <div class="row">
                                                                                ...
                                                                                if ($jmldata > 3) $ukuran = 'col-md-4';
                                                                                else $ukuran = "col-md-12";
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 top10">
                                                        <div class="kotak text-center">
                                                            ...
                                                            <div class="font14" id="v-nomr"><?php if (!empty($lastantrean)) echo $lastantrean->nomr;
                                                                                            else echo "-"; ?></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 top10">
                                                        <div class="kotak text-center">
                                                            ...
                                                            <div class="font14" id="v-waktudaftar"><?php if (!empty($lastantrean)) echo $lastantrean->tgl_masuk;
                                                                                                    else echo "-"; ?></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 top10">
                                                    ...
                                                    <div class="col-md-4 top10">
                                                        <div class="kotak text-center">
                                                            ...
                                                            <div class="font14" id="v-nik"><?php if (!empty($lastantrean)) echo $lastantrean->no_ktp;
                                                                                            else echo "-"; ?></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 top10">
                                                        <div class="kotak text-center">
                                                            ...
                                                            <div class="font14" id="v-nama"><?php if (!empty($lastantrean)) echo $lastantrean->nama_pasien;
                                                                                            else echo "-"; ?></div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-md-6 table-responsive">
                                        ...
                                        <form class="form-horizontal kotak" name="kotak" id="form" action="#">
                                            ...
                                            <div id="v-nomorantrean">
                                                <input type="hidden" name="nomorantri" id="nomorantri" class="form-control pull-right" value="<?php if (!empty($lastantrean)) echo $lastantrean->no_antrian_poly;
                                                                                                                                                else echo "0"; ?>">
                                            </div>
                                            <!-- <div class="form-group">
