...
function kembali(){
    ...
    var url = '<?php echo base_url().'nota_tagihan.php/layanan' ?>';
    window.location.href = url;
}
function print_reg(){
    var reg_unit = '<?php echo encrypt_decrypt('encrypt',$reg_unit,true) ?>';
    var url = '<?php echo base_url().'nota_tagihan.php/layanan/cetakReg?kode=' ?>' + reg_unit;
    openInNewTab(url);
}
function buat_nota(){
    var a = '<?php echo $idx ?>';
    var url = '<?php echo base_url().'nota_tagihan.php/layanan/entry_nota?idx=' ?>' + a;
    window.location.href = url;
}
