			...
			?>
				...
				if (empty($pindah)) {
					...
					<div class="col-md-12">
						...
						dan waktu pasien selesai dilayani akan diambil otomatis dari waktu sekarang, 
						jadi diharapkan petugas untuk menginput sesuai jam pasien selesai dilayani
						</div>
					</div>
						...
						<form id="form1" role="form" onsubmit="return false">
							...
							<input type="hidden" name="kodebooking" id="kodebooking" value="<?php if(!empty($antrean->kodebooking)) echo $antrean->kodebooking ?>">
                            <input type="hidden" name="taskid" id="taskid" value="5">
								...
								<div class="form-group">
									...
									<div class="input-group" id="btnExec">
										...
										<button type="button" class="btn btn-danger" id="submit" <?php if ($pulang > 0 || $detail->status_transaksi == 0) echo "disabled"; ?> onclick="simpanPulang()">
											<i class="glyphicon glyphicon-floppy-disk" id="iconSimpanPulang"></i> Simpan</button>
									</div>
								</div>
							</div>
						</form>
