...
<body id="A4">
    ...
    <table width="100%" border="0">
        <tr>
            ...
            <td><?php echo '<b>'.getRegRsByRegUnitPendaftaran($reg_unit).'</b>' ?></td>
            <td>No Reg Unit</td>
            <td align="center">:</td>
        ...
        <tr>
            <td>No.MR</td>
            <td align="center">:</td>
            <td><?php echo getNomrByRegUnitPendaftaran($reg_unit) ?></td>
            <td>Unit</td>
            <td align="center">:</td>
            <td><?php echo getNamaRuangByRegUnitPendaftaran($reg_unit) ?></td>
        </tr>
        <tr>
            <td>Pasien</td>
            <td align="center">:</td>
            <td><?php echo getNamaPasienByRegUnitPendaftaran($reg_unit) ?></td>
            <td>Jenis Layanan</td>
            <td align="center">:</td>
            <td><?php echo getJenisLayananByRegUnitPendaftaran($reg_unit) ?></td>
        </tr>
    </table>
        ...
        <tbody>
            <?php 
                ...
                foreach($datDetail->result_array() as $x): 
                    $grandTotal = $grandTotal + $x['sub_total_tarif'];
            ?>
            <tr>
                <td align="center"><?php echo $i++; ?></td>
                <td><?php echo $x['layanan'] ?></td>
                <td align="right"><?php echo number_format($x['tarif_layanan'],0,',','.') ?></td>
                <td align="right"><?php echo number_format($x['jml'],0,',','.') ?></td>
                <td align="right"><?php echo number_format($x['sub_total_tarif'],0,',','.') ?></td>
            </tr>
            <?php 
                endforeach; 
            ?>
