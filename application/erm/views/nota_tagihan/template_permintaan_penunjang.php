        ...
        <div class="col-xs-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        <a href="<?= base_url() ."nota_tagihan.php/nota_tagihan/tambah?kLok=" .$ruangID; ?>" id="btnKembali" class="btn btn-default">
            ...
            success : function(data){
                ...
                if(data["status"]==true){
                    ...
                    for(var i=0; i<jmlData;i++){
                        ...
                        if(tindakan[i]["semua_variabel"]==1){
                            tabel+='<tr >';
                            tabel+="<td>"+start+"</td>";
            ...
            $.ajax({
                ...
                success : function(data){
                    if(data.code == 200){
                        console.clear();
                        console.log(data);
                        var url = '<?php echo base_url().'nota_tagihan.php/nota_tagihan/entry_nota?idx=' ?>' + data.idx + "&kLok=" + data.klok;
                        window.location.href = url;
                    }else{
                        alert(data.message)
                    }
