...
<?php
	error_reporting(0);
	$sep = $this->uri->segment(3);
	$nobpjs = $this->uri->segment(4);
   ...
   <table align="left" id='tbl_rs' border=0>
        <tr>
			...
			<table align="left" width='300px' border=0>
				...
				<tr><td colspan='2' style='border-bottom:dashed thin #000;font-size:15px;' align='left'>User : (<?php echo $data['id_user']; ?>) </td></tr>
			</table>
		  </th>
