...
<body class="hold-transition <?= getSkin(3); ?> sidebar-mini">
    <div class="wrapper">
        <?php echo $header; ?>
    ...
    <script>
        ...
        function showNotify() {
            var url = "<?= base_url() . "nota_tagihan.php/notify" ?>";
            //console.clear();
        ...
        function bacaNotif(id) {
            var url = "<?= base_url() . "nota_tagihan.php/notify/baca/" ?>" + id;
            //console.clear();
            console.log('Cek Notif ...')
            $.ajax({
                url: url,
                ...
                success: function(data) {
                    ...
                    var html_notif = "";
                    if (data.status == true) {
                        window.location.href = url_utama + "nota_tagihan.php/nota_tagihan/entry_nota?idx=" + data.idx + "&kLok=" + data.data.notif_tujuan;
                    }
                },
                error: function(jqXHR, ajaxOption, errorThrown) {
                    console.log(jqXHR.responseText);
