<section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree" id="menu">
        ...
        <li class="<?php echo $nav_1; ?>">
            <a href="<?php echo base_url() . 'mr_registrasi.php/dashboard' ?>">
                <i class="fa fa-home"></i> <span>Home</span></a>
        </li>
        <div id="menu"></div>
        <li class="treeview <?php echo $nav_2; ?>">
            <a href="#"><i class="fa fa-list"></i> <span>Data Wilayah</span>
                <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                </span>
            </a>
            <ul class="treeview-menu">
                <li><a href="<?php echo base_url() . 'mr_registrasi.php/negara' ?>">
                        <i class="fa fa-circle-o text-red"></i>Negara</a></li>
                <li><a href="<?php echo base_url() . 'mr_registrasi.php/wilayah' ?>">
                        <i class="fa fa-circle-o text-red"></i>Wilayah</a></li>
                <!--li><a href="<?php //echo base_url().'mr_registrasi.php/kab_kota' 
                                ?>">
                    <i class="fa fa-circle-o text-red"></i>Kabupaten/Kota</a></li>
                <li><a href="<?php //echo base_url().'mr_registrasi.php/kecamatan' 
                                ?>">
                    <i class="fa fa-circle-o text-red"></i>Kecamatan</a></li>
                <li><a href="<?php //echo base_url().'mr_registrasi.php/kelurahan' 
                                ?>">
                    <i class="fa fa-circle-o text-red"></i>Kelurahan</a></li-->

            </ul>
        </li>
        <li class="<?php echo $nav_3; ?>">
            <a href="<?php echo base_url() . 'mr_registrasi.php/pasien_baru' ?>">
                <i class="fa fa-users"></i> <span>Data Pasien</span></a>
        </li>
        <li class="treeview <?php echo $nav_4; ?>">
            <a href="#"><i class="fa fa-list"></i> <span>Registrasi</span>
                <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                </span>
            </a>
            <ul class="treeview-menu">
                <li><a href="<?php echo base_url() . 'mr_registrasi.php/registrasi/rawat_jalan' ?>">
                        <i class="fa fa-circle-o text-red"></i>Rawat Jalan</a></li>
                <li><a href="<?php echo base_url() . 'mr_registrasi.php/registrasi/rawat_inap' ?>">
                        <i class="fa fa-circle-o text-red"></i>Rawat Inap</a></li>
                <li><a href="<?php echo base_url() . 'mr_registrasi.php/registrasi/gawat_darurat' ?>">
                        <i class="fa fa-circle-o text-red"></i>Instalasi Gawat Darurat</a></li>
            </ul>
        </li>
        <li class="<?php echo $nav_7; ?>">
            <a href="<?php echo base_url() . 'mr_registrasi.php/online' ?>"><i class="fa fa-globe"></i> <span>Online</span></a>
        </li>
        <li class="<?php echo $nav_8; ?>">
            <a href="<?php echo base_url() . 'mr_registrasi.php/bed' ?>"><i class="fa fa-bed"></i> <span>Bed Monitoring</span></a>
        </li>
        <li class="<?php echo $nav_5; ?>">
            <a href="<?php echo base_url() . 'mr_registrasi.php/riwayat' ?>">
                <i class="fa fa-list"></i> Riwayat Kunjungan Pasien</a>
        </li>
        <li class="treeview <?php echo $nav_6; ?>">
            <a href="#"><i class="fa fa-print"></i> <span>Laporan Kunjungan</span>
                <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                </span>
            </a>
            <ul class="treeview-menu">
                <li><a href="<?php echo base_url() . 'mr_registrasi.php/laporan_kunjungan/kunjungan_rs' ?>">
                        <i class="fa fa-circle-o text-red"></i>Laporan Kunjungan RS</a></li>
                <li><a href="<?php echo base_url() . 'mr_registrasi.php/laporan_kunjungan/kunjungan_unit' ?>">
                        <i class="fa fa-circle-o text-red"></i>Laporan Kunjungan Unit</a></li>
            </ul>
        </li>
