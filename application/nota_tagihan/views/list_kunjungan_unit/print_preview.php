    ...
    <table width="100%" border="0">
        <tr>
            <td align="center" style="font-size: 1.2em;font-weight: bolder;">
                Laporan Pasien Keluar di <?php echo getRuangByID($id_ruang) ?>
            </td>
        </tr>
        <tr>
...
$(document).ready(function(){
    ...
    function getTable(){
        ...
        $.ajax({
            url         : "<?php echo base_url().'nota_tagihan.php/list_kunjungan_unit/get_print_data' ?>",
            type        : "POST",
