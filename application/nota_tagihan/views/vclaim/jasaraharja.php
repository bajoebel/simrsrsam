                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="noKartu" id="c-noKartu" class="form-control input-sm">
                                        <span class="input-group-btn">
                                            <button class="btn btn-primary btn-sm" id="btnSuplesiJasaraharja" onclick="suplesiJasaraharja()"><span class="fa fa-search" id="iconbtnSuplesiJasaraharja"></span> Cek Suplesi</button>
                                        </span>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="noKartu" id="l-noKartu" class="form-control input-sm" value="">
                                        <span class="input-group-btn">
                                            <button class="btn btn-primary btn-sm" id="btnDataIndukKecelakaan" onclick="dataKecelakaan()"><span class="fa fa-search" id="iconbtnDataIndukKecelakaan"></span> Search</button>
                                        </span>
                                    </div>
