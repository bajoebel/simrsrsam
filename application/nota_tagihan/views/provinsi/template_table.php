                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <div class="input-group input-group-sm" style="width: 200px;">
                            <input type="text" id="keyword" name="keyword" class="form-control pull-right" placeholder="Enter nama provinsi" style="width: 200px"/>
...
$(document).ready(function () { 
    ...
    $('#btnRefresh').click(function(){
        $('input').val('');
        $.ajax({
            url : "<?php echo base_url().'mr_registrasi.php/provinsi/getView' ?>",
            type        : "POST",
            data        : {sLike:""},
            beforeSend  : function(){
...
function hapus(a){
    ...
    if(x){
        $.ajax({
            url         : "<?php echo base_url().'mr_registrasi.php/provinsi/hapus' ?>",
            type        : "POST",
            data        : {idx:a},
            dataType    : "JSON",
            success     : function(data){
...
function simpan(){
    ...
    if(a==""){
        alert('Ops. nama provinsi harus di isi.');
    }else{
        $.ajax({
