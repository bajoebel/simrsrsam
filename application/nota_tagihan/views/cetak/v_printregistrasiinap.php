...
<td>
   <table align="left" id='tbl_rs' border=0>
        <tr>
            <th colspan="5" align="left">
                <div style="font-size: 18px;border: 0px solid #000;">
                    SURAT REGISTRASI PASIEN RAWAT INAP
                    <br/>
                    <?php echo getRS() ?>
                    <br /><br />
                </div>
        ...
        <tr>
            ...
            <td valign="top">: <?php echo $nama_pasien ?> - No.MR : <?php echo $nomr ?></td>
            <td>&nbsp;</td>
        ...
        <tr>
            ...
            <td valign="top" rowspan="3">: <?php echo ucwords(strtoupper($alamat)) ?>, 
                        ...
                        <?php echo $nama_kab_kota ?>, 
                        <?php echo $nama_provinsi ?> </td>
            <td>&nbsp;</td>
            <td valign="top">Penanggung Jawab</td>
            <td valign="top">: <?php echo $pjPasienNama ?></td>
        </tr>
		<tr>
            <td>&nbsp;</td>
            <td valign="top">No HP</td>
            <td valign="top">: <?php echo $pjPasienTelp ?></td>
        </tr>
		<tr>
            <td colspan="3"><br /></td>
        </tr>
