                    ...
                    <div class="box-body">
                        ...
                        <div style="font-size: 16px;margin-top:10px;">
                            ...
                            <ul class="nav nav-stacked">
                                ...
                                ?>
                                    <li class="<?php if ($mod == "tindakan") echo "active"; ?>"><a href="<?php echo base_url() . "nota_tagihan.php/nota_tagihan/entry_nota?idx=" . $idx . "&kLok=" . $ruangID;
                                                                                                            ?>">Tindakan </a></li>
                                <?php
                                }
                                ...
                                ?>
                                    <li class="<?php if ($mod == "penunjang") echo "active"; ?>"><a href="<?php if ($detail->status_transaksi == 0) echo  base_url() . "nota_tagihan.php/nota_tagihan/permintaan_penunjang?idx=" . $idx . "&kLok=" . $ruangID;
                                                                                                            else echo "#";
                                ...
                                ?>
                                    <li class="<?php if ($mod == "rujukan") echo "active"; ?>"><a href="<?php if ($detail->status_transaksi == 0) echo  base_url() . "nota_tagihan.php/nota_tagihan/rujukan_internal?idx=" . $idx . "&kLok=" . $ruangID;
                                                                                                        else echo "#";
                                ...
                                ?>
                                    <li class="<?php if ($mod == "operasi") echo "active"; ?>"><a href="<?php if ($detail->status_transaksi == 0) echo  base_url() . "nota_tagihan.php/nota_tagihan/operasi?idx=" . $idx . "&kLok=" . $ruangID;
                                                                                                        else echo "#";
                                                                                                        ?>">Operasi </a></li>
                                    <?php
                                }
                                ...
                                if (in_array(11, $arr_aksi)) {
                                    ...
                                    ?>
                                        <li class="<?php if ($mod == "diagnosa") echo "active"; ?>"><a href="<?php echo base_url() . "nota_tagihan.php/nota_tagihan/diagnosa?idx=" . $idx . "&kLok=" . $ruangID;
                                ...
                                if (in_array(14, $arr_aksi)) {
                                    ...
                                    ?>
                                        <li class="<?php if ($mod == "diagnosa-akhir") echo "active"; ?>"><a href="#<?php //echo base_url() . "nota_tagihan.php/nota_tagihan/diagnosa_akhir?idx=" . $idx . "&kLok=" . $ruangID; 
                                                                                                                    ?>">Diagnosa Akhir </a></li>
                                    <?php
                                    endif;
                                }
