                ...
                <div class="box-header with-border">
                    ...
                    <div class="col-lg-6 col-xs-12 mb-1">
                        <div class="input-group input-group-sm">
                            <input type="text" id="txtKeyword" class="form-control" placeholder="Enter ruang layanan" />
                    ...
                    <div class="box-body">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="ruang_layanan">
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function getTable() {
        ...
        $.ajax({
            url: "<?php echo base_url() . 'ruang/getView' ?>",
            type: "POST",
            data: formdata,
            beforeSend: function() {
                $('.loading').modal('show');
    ...
    function hapus(a) {
        ...
        if (x) {
            ...
            formdata['idx'] = a;
            $.ajax({
                url: "<?php echo base_url() . 'ruang/hapus' ?>",
                type: "POST",
                data: formdata,
                dataType: "JSON",
                success: function(data) {
    ...
    function simpan() {
        ...
        formdata['ruang_layanan'] = $('#ruang_layanan').val();

        if (formdata['ruang_layanan'] == "") {
            alert('Ops. Ruang Layanan harus di isi.');
            $('#ruang_layanan').focus();
        } else {
            $.ajax({
                url: "<?php echo base_url() . 'ruang/simpan' ?>",
                type: "POST",
                data: formdata,
                dataType: "JSON",
                success: function(data) {
