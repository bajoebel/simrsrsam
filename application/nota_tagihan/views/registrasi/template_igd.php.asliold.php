...
$(document).ready(function () { 
    ...
    //$('select').not('#optJnsRujukan').not('#optAsalRujukan').not('#cbstatuskll').not('#cbpropinsi').not('#cbkabupaten').not('#cbkecamatan').not('#dokterJaga').not("#id_ruang").not('#id_rujuk').not("#id_cara_bayar").not('#id_pengirim').select2({placeholder:'-- Pilih --'});
