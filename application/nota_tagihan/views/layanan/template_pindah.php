        ...
        ?>
                <div class="col-xs-6">
                    ...
                    <div class="box-footer text-right">
                        ...
                        <button class="btn btn-success" onclick="simpanPindahRanap()">Simpan</button>
                    </div>
                </div>
            <?php
            } else {
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><?php if (empty($pasien_pendah->idx_batal)) echo "Belum Disetujui";
                                    else echo "Sudah Disetujui"; ?></td>
                                <td class="text-right">
                                    <?php if (empty($pasien_pendah->idx_batal)) echo "<button class='btn btn-danger' onclick='batal(\"" . $pasien_pindah->idx . "\")'>Batalkan</button>"; ?>
