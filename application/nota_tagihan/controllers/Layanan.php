...
class Layanan extends CI_Controller
{
                ...
                if ($this->session->userdata('kdlokasi')) {
                    ...
                    if ($this->session->userdata('kdlokasi') == "") {
                        ...
                        if($ruang->grid==1||$ruang->grid==4) {
                            ...
                            $field = array('id_daftar', 'reg_unit', 'tgl_masuk', 'nomr', 'nama_pasien', 'tgl_lahir', '=jekel[{{jns_kelamin}}]', 'namaDokterJaga', '{{nama_ruang}}','cara_bayar');
                        ...
                        elseif($ruang->grid==2) {
                            ...
                            $field= array('id_daftar', 'reg_unit', 'tgl_masuk', 'nomr', 'nama_pasien', 'tgl_lahir', '=jekel[{{jns_kelamin}}]', 'namaDokterJaga', '{{nama_ruang}} / {{nama_kamar}}', 'kelas_layanan', 'cara_bayar');
                        ...
                        $config = array(
                            ...
                            'variable'      => array('idx' => 'idx', 'nama_ruang' => 'nama_ruang', 'nama_kamar' => 'nama_kamar','jns_kelamin'=>'jns_kelamin'),
                            'field'         => $field,
                        ...
                        $theme=array(
                            ...
                            'ajaxdata' => "var jekel = {'0':'Perempuan','1':'Laki-Laki','P':'Perempuan','L':'Laki-Laki'};var response = {'0':'<span class=\"btn btn-danger btn-xs\" >Belum Diresponse</span>','1':'<span class=\"btn btn-success btn-xs\">Sudah Diresponse</span>'}; var dis=['','disabled']" 
    ...
    function tindakan($id_permintaan)
    {
        ...
        if ($ses_state) {
            ...
            $tindakan = $this->db->get('tbl02_permintaan_tindakan_penunjang');
