                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <div class="input-group input-group-sm" style="width: 200px;">
                            <input type="text" id="keyword" name="keyword" class="form-control pull-right" placeholder="Enter Tindakan Pelayanan" style="width: 200px"/>
                        ...
                        <div class="box-body">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="jenis_pelayanan">Tindakan Pelayanan</label>
...
$(document).ready(function () { 
    ...
    $('#btnRefresh').click(function(){
        $('input').val('');
        $.ajax({
            url : "<?php echo base_url().'administrator.php/jenis_pelayanan/getView' ?>",
            type        : "POST",
            data        : {sLike:""},
            beforeSend  : function(){
...
function hapus(a){
    ...
    if(x){
        $.ajax({
            url         : "<?php echo base_url().'administrator.php/jenis_pelayanan/hapus' ?>",
            type        : "POST",
            data        : {idx:a},
            dataType    : "JSON",
            success     : function(data){
...
function simpan(){
    var a = $('#jenis_pelayanan').val();
    if(a==""){
        alert('Ops. jenis layanan harus di isi.');
    }else{
        $.ajax({
            url         : "<?php echo base_url().'administrator.php/jenis_pelayanan/simpan' ?>",
            type        : "POST",
