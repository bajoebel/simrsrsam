...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#btnTambah').click(function() {
            var url = "<?php echo base_url() . 'administrator.php/ruang_pelayanan/tambahkamar/' .$ruangid ?>";
        ...
        $('#btnRefresh').click(function() {
            $('input').val('');
            $.ajax({
                url: "<?php echo base_url() . 'administrator.php/ruang_pelayanan/getkamar/' . $ruangid ?>",
                type: "POST",
                data: {
                    sLike: ""
                },
    ...
    function getTable() {
        console.log("<?php echo base_url() . 'administrator.php/ruang_pelayanan/getkamar/' . $ruangid; ?>");
        $.ajax({
            url: "<?php echo base_url() . 'administrator.php/ruang_pelayanan/getkamar/' . $ruangid; ?>",
            beforeSend: function() {
                $('tbody#getdata').html("<tr><td colspan=6><i class='fa fa-refresh fa-spin'></i> Permintaan sedang diproses... Silahkan ditunggu</td></tr>");
    ...
    function hapus(a) {
        ...
        if (x) {
            $.ajax({
                url: "<?php echo base_url() . 'administrator.php/ruang_pelayanan/hapuskamar/'.$ruangid ?>",
                type: "POST",
                data: {
                    idx: a
                },
