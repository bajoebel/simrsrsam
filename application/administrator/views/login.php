...
<div class="login-box">
    <div class="login-box-body">
        ...
        <form id="form1" method="post" onSubmit="return false">
            ...
            <div class="row">
                <div class="col-xs-6">
                    <button type="button" id="utama" class="btn btn-success btn-block btn-flat">
                        <span class="fa fa-building"></span> Halaman Utama</button>
                </div>
                <div class="col-xs-6">    
                    <button type="button" id="btnLogin" class="btn btn-danger btn-block btn-flat">
...
$(function () {
    $('#btnLogin').click(function(){
        $.ajax({
            type    : "POST",
            url     : "<?php echo base_url().'administrator.php/login/cek' ?>",
