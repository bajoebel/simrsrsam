...
function getTable(start){
    ...
    var url = base_url+"aplicares/datakemkes";
    console.clear()
    console.log(url)
    $.ajax({
        url     : url,
        ...
        $('tbody#getdata').html('');
                ...
                for(var i=0; i<jmlData;i++){
                    ...
                    tabel+="<td>"+res[i].ruang + "</td>";
                    tabel+="<td>"+res[i].tt + "</td>";
                    
                    tabel+="<td>"+res[i].jumlah_ruang + "</td>";
                    tabel+="<td>"+res[i].terpakai + "</td>";
                    tabel+="<td style='text-align:right;'>"+
                    "<div class='btn-group'>"+
                    "<button onclick='editRuangAplicares(\""+res[i].id_tt+"\",\""+res[i].tt+"\",\""+res[i].ruang+"\",\""+res[i].jumlah_ruang+"\",\""+res[i].jumlah+"\",\""+res[i].terpakai+"\",\""+res[i].antrian+"\",\""+res[i].prepare+"\",\""+res[i].prepare_plan+"\",\""+res[i].kosong+"\",\""+res[i].covid+"\",\""+res[i].id_t_tt+"\")' class='btn btn-warning btn-sm'><span class='fa fa-pencil'></span> Edit</button>"+
                    "<button onclick='hapusRuangAplicares(\""+res[i].id_tt+"\")' class='btn btn-danger btn-sm'><span class='fa fa-remove'></span> Hapus</button>"+
                    "</div></td>";tabel+="</tr>";
