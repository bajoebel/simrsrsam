                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <div class="input-group input-group-sm" style="width: 200px;">
                            <input type="text" id="keyword" name="keyword" class="form-control pull-right" placeholder="Enter Cara Bayar" style="width: 200px" />
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#btnRefresh').click(function() {
            $('input').val('');
            $.ajax({
                url: "<?php echo base_url() . 'administrator.php/cara_bayar/getView' ?>",
                type: "POST",
                data: {
                    sLike: ""
                },
    ...
    function simpan() {
        var a = $('#cara_bayar').val();
        if (a == "") {
            alert('Ops. Cara Bayar harus di isi.');
        } else {
            $.ajax({
                url: "<?php echo base_url() . 'administrator.php/cara_bayar/simpan' ?>",
                type: "POST",
    ...
    function hapus(a) {
        ...
        if (x) {
            $.ajax({
                url: "<?php echo base_url() . 'administrator.php/cara_bayar/hapus' ?>",
                type: "POST",
                data: {
                    idx: a
                },
