            ...
            <div class="box box-success">
                <div class="box-body">
                    ...
                    <div class="alert alert-danger alert-dismissible">
                        <p>Cari dan pilih pegawai yang akan diizinkan mengakses Aplikasi Farmasi</p>
                    </div> 
...
$(document).ready(function () { 
    ...
    $('#keywordFarmasiApp').keypress(function(ev){
        ...
        if (keycode == '13') {
            $.ajax({
                url         : "<?php echo base_url().'administrator.php/app_users/getSelectViewFarmasiApp' ?>",
                type        : "POST",
                data        : {sLike:$(this).val()},
                beforeSend  : function(){
                    $('tbody#getSelectFarmasiApp').html("<tr><td colspan=4>Loading... Please wait</td></tr>");
                },
                success : function(data){
                    $('tbody#getSelectFarmasiApp').html(data);
                },
...
function pilihFarmasiApp(a){
    $.ajax({
        url         : "<?php echo base_url().'administrator.php/app_users/pilihFarmasiApp' ?>",
        type        : "POST",
        data        : {NRP:a},
        dataType    : "JSON",
        success     : function(data){
