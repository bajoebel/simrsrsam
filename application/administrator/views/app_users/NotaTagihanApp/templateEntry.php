            ...
            <div class="box box-success">
                <div class="box-body">   
                    <div class="alert alert-danger alert-dismissible">
                        <p>Cari dan pilih pegawai yang akan diizinkan mengakses Aplikasi Nota Tagihan</p>
                    </div> 
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            <tbody id="getSelectNotaTagihanApp">
                                <tr>
...
$(document).ready(function () { 
    ...
    $('#keywordNotaTagihanApp').keypress(function(ev){
        ...
        if (keycode == '13') {
            $.ajax({
                url         : "<?php echo base_url().'administrator.php/app_users/getSelectViewNotaTagihanApp' ?>",
                type        : "POST",
                data        : {sLike:$(this).val()},
                beforeSend  : function(){
                    $('tbody#getSelectNotaTagihanApp').html("<tr><td colspan=4>Loading... Please wait</td></tr>");
                },
                success : function(data){
                    $('tbody#getSelectNotaTagihanApp').html(data);
                },
...
function pilihNotaTagihanApp(a){
    $.ajax({
        url         : "<?php echo base_url().'administrator.php/app_users/pilihNotaTagihanApp' ?>",
        type        : "POST",
        data        : {NRP:a},
        dataType    : "JSON",
        success     : function(data){
