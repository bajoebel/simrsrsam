            ...
            <div class="box box-success">
                <div class="box-body">
                    <div class="alert alert-danger alert-dismissible">
                        <p>Cari dan pilih pegawai yang akan diizinkan mengakses MR Registrasi App </p>
                    </div> 
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            <tbody id="getSelectMrRegistrasiApp">
                                <tr>
...
$(document).ready(function () { 
    ...
    $('#keywordMrRegistrasiApp').keypress(function(ev){
        ...
        if (keycode == '13') {
            $.ajax({
                url         : "<?php echo base_url().'administrator.php/app_users/getSelectViewMrRegistrasiApp' ?>",
                type        : "POST",
                data        : {sLike:$(this).val()},
                beforeSend  : function(){
                    $('tbody#getSelectMrRegistrasiApp').html("<tr><td colspan=4>Loading... Please wait</td></tr>");
                },
                success : function(data){
                    $('tbody#getSelectMrRegistrasiApp').html(data);
                },
...
function pilihMrRegistrasiApp(a){
    $.ajax({
        url         : "<?php echo base_url().'administrator.php/app_users/pilihMrRegistrasiApp' ?>",
        type        : "POST",
        data        : {NRP:a},
        dataType    : "JSON",
        success     : function(data){
...
function getTableMrRegistrasiApp(){
    $.ajax({
        ...
        data        : {sLike:""},
        beforeSend  : function(){
            $('tbody#getSelectMrRegistrasiApp').html("<tr><td colspan=7>Loading... Please wait</td></tr>");
        },
        success : function(data){
            $('tbody#getSelectMrRegistrasiApp').html(data);
        },
