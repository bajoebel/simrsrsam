...
$(document).ready(function () { 
    ...
    $('#btnRefresh').click(function(){
        $('input').val('');
        $.ajax({
            url : "<?php echo base_url().'administrator.php/bahasa/getView' ?>",
            type        : "POST",
            data        : {sLike:""},
            beforeSend  : function(){
...
function simpan(){
    var a = $('#bahasa').val();
    if(a==""){
        alert('Ops. Bahasa harus di isi.');
    }else{
        $.ajax({
            url         : "<?php echo base_url().'administrator.php/bahasa/simpan' ?>",
            type        : "POST",
...
function hapus(a){
    ...
    if(x){
        $.ajax({
            url         : "<?php echo base_url().'administrator.php/bahasa/hapus' ?>",
            type        : "POST",
            data        : {idx:a},
            dataType    : "JSON",
            success     : function(data){
