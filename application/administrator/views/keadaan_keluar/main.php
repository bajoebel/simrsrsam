                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <div class="input-group input-group-sm" style="width: 200px;">
                            <input type="text" id="keyword" name="keyword" class="form-control pull-right" placeholder="Enter Keadaan Keluar" style="width: 200px"/>
                        ...
                        <div class="box-body">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="keadaan_keluar" id="keadaan_keluar">
                                </div>                        
                            </div>                           
                        </div>
                    </form>
...
$(document).ready(function () { 
    ...
    $('#btnRefresh').click(function(){
        $('input').val('');
        $.ajax({
            url : "<?php echo base_url().'administrator.php/keadaan_keluar/getView' ?>",
            type        : "POST",
            data        : {sLike:""},
            beforeSend  : function(){
...
function hapus(a){
    ...
    if(x){
        $.ajax({
            url         : "<?php echo base_url().'administrator.php/keadaan_keluar/hapus' ?>",
            type        : "POST",
            data        : {idx:a},
            dataType    : "JSON",
            success     : function(data){
...
function simpan(){
    var a = $('#keadaan_keluar').val();
    if(a==""){
        alert('Ops. jenis layanan harus di isi.');
    }else{
        $.ajax({
            url         : "<?php echo base_url().'administrator.php/keadaan_keluar/simpan' ?>",
            type        : "POST",
