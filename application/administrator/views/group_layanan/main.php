...
<section class="content container-fluid">
    <div class="alert alert-danger alert-dismissible">
        <p>Group Layanan Merupakan Standar Sistem. Dilarang menambah atau menghapus data</p>
    </div>    
    <div class="row">
        <div class="col-xs-12">
                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <div class="input-group input-group-sm" style="width: 200px;">
                            <input type="text" id="keyword" name="keyword" class="form-control pull-right" placeholder="Enter Group Layanan" style="width: 200px"/>
                        ...
                        <div class="box-body">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="group_ruang" id="group_ruang">
                                </div>                        
                            </div>                           
                        </div>
                    </form>
...
$(document).ready(function () { 
    ...
    $('#btnRefresh').click(function(){
        $('input').val('');
        $.ajax({
            url : "<?php echo base_url().'administrator.php/group_layanan/getView' ?>",
            type        : "POST",
            data        : {sLike:""},
            beforeSend  : function(){
...
function hapus(a){
    ...
    if(x){
        $.ajax({
            url         : "<?php echo base_url().'administrator.php/group_layanan/hapus' ?>",
            type        : "POST",
            data        : {idx:a},
            dataType    : "JSON",
            success     : function(data){
...
function simpan(){
    var a = $('#group_ruang').val();
    if(a==""){
        alert('Ops. jenis layanan harus di isi.');
    }else{
        $.ajax({
            url         : "<?php echo base_url().'administrator.php/group_layanan/simpan' ?>",
            type        : "POST",
