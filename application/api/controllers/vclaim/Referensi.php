...
class Referensi extends CI_Controller
{
    ...
    {
        $response = null;
        $param1 = $this->input->get('param1', true); // Jenis Pelayanan (1. Rawat Inap, 2. Rawat Jalan)
        $param2 = $this->input->get('param2', true); // Tgl.Pelayanan/SEP (yyyy-mm-dd) 2019-05-10
        $param3 = $this->input->get('param3', true); // Kode Spesialis/Subspesialis (Ex:IGD)
        if (
            !empty($param1) &&
            !empty($param2) 
        ) {
