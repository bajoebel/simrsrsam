						...
						<div class="widget-body">
							<div class="widget-main">
										...
										<div class="row">
												<div class="col-sm-6">
															<div class="form-group">
																...
																<input type="text" name="booking" id="booking" class="col-xs-12 col-sm-3" maxlength="8" placeholder="Enter Kode Booking" style='color:#000000;' value="<?php echo $booking; ?>"/>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-4">
																	<label>
																		<input name="c19" id="c19" value="1" type="checkbox" class="ace"/>
																		<span class="lbl"> CV-19</span>
																	</label>
																</div>
															</div>
								...
								<div class="wizard-actions hide" id="tahap">
									<button class="btn btn-primary" name="daftar" id="daftar">
										DAFTAR
	...
	jQuery(function($) {
		...
		$('#daftar').on('click', function(){
			...
			if($('#tujuan').val()!="GR022"){
				$.ajax({ 
					type	: 'POST',
					url		: "<?php echo base_url().'pendaftaran/cekdpo_daftar'; ?>", 
					data	: "nomr="+nomr, 
					dataType: "JSON",
					success	: function(data){ 
						if(data.NOMR == $('#nomr').val()){
							$.gritter.add({
								title: 'WARNING',
								text: 'Pasien Bermasalah (DPO)... Periksa Kembali.! <br>Nama : '+data.NAMA+'<br>Keterangan : '+data.KET,
                ...
                if(e.keyCode==13){
					...
					$.ajax({ 
						...
						var tglnow = "<?php echo date("Y-m-d") ?>";
							if(data.response.tgl_booking !== tglnow){
