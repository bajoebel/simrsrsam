		...
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				<li>
					...
					<a href="<?php echo base_url('pendaftaran/input_inap');?>">Home</a>
				</li>
				<li class="active">Input Ruang Pasien Rawat Inap</li>
			</ul><!-- /.breadcrumb -->
		</div>
						...
						<div class="widget-body">
							<div class="widget-main">
								...
								<div id="fuelux-wizard-container">
									<form class="form-horizontal" id="pendaftaran" name="pendaftaran" action="<?php echo base_url('pendaftaran/updateranap') ?>" method="POST">
										<div class="row">
												<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-xs-6 col-sm-9">
																	<div class="clearfix">
																		...
																		<input type="hidden" name="idadmissi" id="idadmissi" class="col-xs-12 col-sm-5" style='color:#000000;' readonly/>
																	</div>
																</div>
															</div>
												...
												<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="tglreg" id="tglreg" class="col-xs-12 col-sm-5" style='color:#000000;' readonly/>
																	</div>
																</div>
															</div>
...
<script type="text/javascript">
	...
	jQuery(function($) {
		...
		$('#daftar').on('click', function(){
			...
			$.ajax({
				type : 'POST',
				url : '<?php echo base_url().'pendaftaran/cek_inappasien'; ?>',
				data :  'noreg='+ a,
				success : function(data){
				var response =  eval("(" + data + ")");
					if(response.MESSAGE=="OK"){
						...
						*/
						...
						if(confirm('Apa anda yakin melanjutkan proses perubahan...?')){
		...
		$('#cari').click(function(){
			...
			$.ajax({ 
				type	: 'POST',
				url		: "<?php echo base_url().'pendaftaran/get_cekinap'; ?>", 
				data	: "noreg="+no_reg, 
				dataType: "JSON", 
				success	: function(data){ 
					console.log(data)
					if(data.MESSAGE=="OK"){
						...
						$("#idadmissi").val(data.ID_ADMISSI);
						$("#ruang").val(data.RUANG);
						$('.select2').css('width','300px').select2({allowClear:true})
						.on('change', function(){
							$(this).closest('form').validate().element($(this));
						});
						$("#mapingruang").val(data.RUANGMAPPING);
						//document.getElementById("ruang").disabled = true;
