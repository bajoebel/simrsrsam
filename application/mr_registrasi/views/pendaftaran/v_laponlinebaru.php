        ...
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                <li>
                        ...
                        <a href="<?php echo base_url('pendaftaran/list_onlinebaru');?>">Home</a>
                </li>
...
<script type="text/javascript">
	...
	jQuery(function($) {
		...
		$('#cari').click(function(){
			...
			$.ajax({ 
				type	: 'POST',
				url		: "<?php echo base_url().'pendaftaran/get_laponlinebaru'; ?>", 
				data	: "tgl1="+tgl1+"&tgl2="+tgl2, 
				
				beforeSend  : function(){
					btn.button('reset')
					$('tbody#getdata').html("<tr><td colspan=12>Loading... Please wait</td></tr>");
				},
		...
		$('#cetak').click(function(){
			...
			var url = "<?php echo base_url() .'pendaftaran/cetak_laponlinebaru?tglAwal=' ?>"+tglAwal+"&tglAkhir="+tglAkhir+"&req="+"cetak";
			window.open(url);
