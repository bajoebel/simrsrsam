		...
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				<li>
					...
					<a href="<?php echo base_url('pendaftaran/list_riwayatrajal');?>">Home</a>
				</li>
				<li class="active">Riwayat Pasien Rawat Jalan</li>
			</ul><!-- /.breadcrumb -->
		</div>
		...
		$('#cari').click(function(){
			...
			$.ajax({
				...
				$('#getdata').html("");
					...
					if(response.pasien[a].status=="0"){
					var st = "TERDAFTAR";
					}else if(response.pasien[a].status=="2"){
					var st = "PULANG";
					}else{
					var st = "BATAL";
					}
