		...
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				<li>
					...
					<a href="<?php echo base_url('pendaftaran/list_harianjalan');?>">Home</a>
				</li>
					...
					<div class="col-sm-12">
						<div class="widget-box">
							<div class="widget-header">
								<h4 class="widget-title">DAFTAR HARIAN PASIEN RAWAT JALAN</h4>
							</div>
...
jQuery(function($) {
		...
		$('#cari').click(function(){
			...
			$.ajax({
				type : "POST",
				url  : "<?php echo base_url().'pendaftaran/get_harianjalan'; ?>",
				data : "tgl="+tgl,
				beforeSend  : function(){
		...
		$('#cetak').click(function(){
			...
			var url = "<?php echo base_url() .'pendaftaran/cetak_harianjalan?tgl=' ?>"+tgl+"&req="+"cetak";
			window.open(url);
		...
		$("#export").click(function(){
			...
			var url = "<?php echo base_url() .'pendaftaran/cetak_harianjalan?tgl=' ?>"+tgl+"&req="+"excel";
            window.open(url);
        });
