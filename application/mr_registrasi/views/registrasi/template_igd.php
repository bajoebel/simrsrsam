            ...
            <div class="tab-content">
                <div id="pendaftaran" class="tab-pane fade in active">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                <form id="form1" class="form-horizontal" action="<?php echo base_url() . 'mr_registrasi.php/registrasi/daftar_igd' ?>" method="POST">
                                    <div class="box-body">
                                        <?php
                                        if ($ranap == 1) {
                                        ?>
                                        ...
                                        <div class="col-md-6">
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                                        <?php
                                                        // if (!empty($nama_kelurahan)) $alamat .= " Kel. " . $nama_kelurahan;
                                                        // if (!empty($nama_kecamatan)) $alamat .= " Kec. " . $nama_kecamatan;
                                                        // if (!empty($nama_kab_kota)) $alamat .= " " . $nama_kab_kota;
                                                        // if (!empty($nama_provinsi)) $alamat .= " Prov. " . $nama_provinsi;
                                                        ?>
                                                        <textarea name="privalamat" id="privalamat" cols="30" rows="2" class="form-control input-sm" readonly><?php echo $alamat ." RT ".$rt ." RW ".$rw ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-5 col-sm-5 col-xs-12">
                                                        <div class="input-group">
                                                            <input readonly="" name="jns_layanan" id="jns_layanan" type="text" class="form-control input-sm" value="GD">
                                                            <span class="input-group-addon">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                                        <div class="input-group">
                                                            <select class="form-control input-sm" name="id_cara_bayar" id="id_cara_bayar" onkeydown="enter_carabayar(event)">
                                                                <option value=""></option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                                        <div class="input-group">
                                                            <select class="form-control input-sm" name="id_rujuk" id="id_rujuk">
                                                                <option value=""></option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                                        <div class="input-group">
                                                            <select class="form-control input-sm" name="id_ruang" id="id_ruang" onkeydown="enter_ruangan(event)" onchange="getDokter()">
                                                                <option value=""></option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                                        <div class="input-group">
                                                            <select class="form-control input-sm" name="dokterJaga" id="dokterJaga" onkeydown="enter_dokter(event)">
                                                        ...
                                                        <div class="col-md-8 col-sm-8 col-xs-12">
                                                            <div class="input-group ">
                                                                ...
                                                                <div class="input-group-btn" id='prosessep'>
                                                                    <a href="Javascript:formSEP()" class="btn btn-sm btn-danger">Create SEP (<em>Bridging</em>)</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="nama_icd" id='nama_icd' class='form-control' value=''>
                                                            <span class="input-group-addon">
                                            ...
                                            <div class="col-md-8">
                                                <fieldset>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                        <select name="form-control" id="e-pendidikan" class="form-control input-sm">
                                                            <?php 
                        ...
                        <div class="col-md-9 col-xs-12">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            ...
                                            <input type="hidden" class="form-control input-sm" id="txtkdppkasalrujukan" value="">
                                        </div>
                                    </div>
                                <div id="divRujukan">
                                    <div class="form-group">
                            ...
                            <div class="box-footer">
                                <div id="divSimpan" style="display: block;">
                                    <button type="button" style="margin-left:10px;" id="btnSimpan" class="btn btn-success pull-right" onclick="createSEP()"><i class="fa fa-save" id="iconSep"></i> Simpan</button>
                                </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        getHistoryPasien();
        // $('select').not('#optJnsRujukan').not('#optAsalRujukan').not('#lakaLantas').not('#cbprovinsi').not('#cbkabupaten').not('#cbkecamatan').not('#id_pengirim').not('#kewarganegaraan').not('#x-agama').not('#e-agama').not('#e-pendidikan').not('#e-pekerjaan').not('#e-status_kawin').not('#x-pekerjaan').not('#x-suku').not('#x-bahasa').not('#x-status_kawin').select2({
        //     placeholder: '-- Pilih --'
        // });
        ...
        $("#txtnmpoli").autocomplete({
            ...
            $("#txtppkasalrujukan").autocomplete({
                source: function(request, response) {
                    ...
                    $.ajax({
                        url: "<?php echo base_url() . 'mr_registrasi.php/vclaim/referensi/faskes/' ?>",
                        dataType: "JSON",
                        method: "GET",
                        data: {
                            param: request.term
        ...
        */
        /*$("#txtnmDokter").autocomplete({
                source: function(request, response) {
                    ...
                    $.ajax({
                        url: "<?php echo base_url() . 'api.php/vclaim/referensi/dpjp' ?>",
                        dataType: "JSON",
                        method: "POST",
                        data: {
                            param1: request.term
