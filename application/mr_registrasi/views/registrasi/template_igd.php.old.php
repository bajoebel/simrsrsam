                        ...
                        <div class="col-md-6">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <input name="pjPasienNama" id="pjPasienNama" type="text" class="form-control">     
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 col-sm-4 col-xs-12 control-label">Umur</label>
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <input name="pjPasienUmur" id="pjPasienUmur" type="text" class="form-control">     
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 col-sm-4 col-xs-12 control-label">Pekerjaan</label>
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <input name="pjPasienPekerjaan" id="pjPasienPekerjaan" type="text" class="form-control">     
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5 col-sm-5 col-xs-12">
                                        <div class="input-group">
                                            <select class="form-control" name="dokterJaga" id="dokterJaga" style="width: 300px">
                                                <option value=""></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5 col-sm-5 col-xs-12">
                                        <div class="input-group">
                                            <select class="form-control" name="id_ruang" id="id_ruang" style="width: 300px">
                                                <option value=""></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5 col-sm-5 col-xs-12">
                                        <div class="input-group">
                                            <select class="form-control" name="id_rujuk" id="id_rujuk" style="width: 300px">
                                                <option value=""></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <input name="pjPasienDikirimOleh" id="pjPasienDikirimOleh" type="text" class="form-control">     
                                    </div>
                                </div>    
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5 col-sm-5 col-xs-12">
                                        <div class="input-group">
                                            <select class="form-control" name="id_cara_bayar" id="id_cara_bayar" style="width: 300px">
                                                <option value=""></option>
                                ...
                                <div class="form-group divRegCredit">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="input-group">
                                            <input name="no_bpjs" id="no_bpjs" type="text" class="form-control" value="<?php echo $no_bpjs; ?>">   
                                            <span class="input-group-addon">
                                ...
                                <div class="form-group divRegCredit">
                                    ...
                                    <a href="Javascript:formSEP()" class="btn btn-danger disabled">Create SEP (<em>Bridging</em>)</a>
                                        </div>                                        
                                    </div>
                                </div>
                                <div class="form-group">
...
$(document).ready(function () { 
    ...
    getHistoryPasien();
    $('select').not('#optJnsRujukan').not('#optAsalRujukan').not('#cbstatuskll').not('#cbpropinsi').not('#cbkabupaten').not('#cbkecamatan').select2({placeholder:'-- Pilih --'});
    ...
    $('#daftar').click(function(){
        ...
        if(formdata['nomr']=="" || formdata['nama_pasien']==""){
            ...
            if(x){
                $.ajax({
                    url         : "<?php echo base_url().'mr_registrasi.php/registrasi/simpan_reg_igd' ?>",
                    type        : "POST",
                    data        : formdata,
                    dataType    : "JSON",
