                ...
                <div class="box-body">
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="#tab_4" title="Rencana Kontrol" data-toggle="tab" onclick='rencanaKontrol()'><span class="fa fa-user-md"></span></a></li>
                        </ul>
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_1">
                                <ul class="list-group list-group-unbordered">
                                    ...
                                    <li class="list-group-item">
                                        <span class="fa fa-hospital-o"></span> <a title="Hak Kelas Rawat" class="pull-right-container" id="lblhakkelas"> <?= $kelas_layanan?></a>
        ...
        <div class="col-md-6">
            <div class="box box-success">
                <div class="box-body no-padding">
                    <ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" href="#home"><span class="fa fa-user"></span> Info Layanan</a></li>
                        <li><a data-toggle="tab" href="#menu1"><span class="fa fa-file-o"></span> Buat Rujukan Online</a></li>
                        <?php 
                        if (empty($no_jaminan)) { 
                        ?>
                        <li><a data-toggle="tab" href="#menu2" onclick='cekPeserta()'><span class="fa fa-file-text-o" ></span> Buat SEP</a></li>
                        <?php
                        }
                        ?>
                    </ul>
                        ...
                        <div id="home" class="tab-pane fade in active">
                            <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <th>Jenis Layanan</th>
                                            <th style="font-size: 20px"><?= $jns_layanan ?></th>
                                        </tr>
                                        <tr>
                                            <th>No Registrasi Unit</th>
                                            <th style="font-size: 20px"><?= $reg_unit ?></th>
                                        </tr>
                                        <tr>
                                            <th>Tempat/Tgl.Lahir</th>
                                            <th><?= $tempat_lahir . ', ' . $tgl_lahir ?></th>
                                        </tr>
                                        <tr>
                                            <th>Jenis Kelamin</th>
                                            <th><?= ($jns_kelamin=='1') ? "Laki-Laki" : "Perempuan" ?></th>
                                        </tr>
                                        <tr>
                                            <th>Tujuan Layanan</th>
                                            <th id="tujuan"><?= $nama_ruang ?></th>
                                        </tr>
                                        <tr>
                                            <th>Kelas Layanan</th>
                                            <th><?= 'Kelas ' . $kelas_layanan ?></th>
                                        </tr>
                                        <tr>
                            ...
                            <form class="form-horizontal" id="theform" style="font-size:12px">
                                <div class="row">
                                    <div class="col-md-12 col-xs-12">
                                        ...
                                        <!-- Informasi Rujukan -->
                                        <input type="hidden" name="asalRujukan" id="asalRujukan" value="2">
                                        <!-- <input type="hidden" name="tglRujukan" id="tglRujukan" value=""> -->
                                        <input type="hidden" name="jns_layanan" id="jns_layanan" value="RI">
                                        <input type="hidden" name="ppkRujukan" id="ppkRujukan" value="<?= KODERS_VC ?>">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group" id="divPoli" style="display:none;">
                                            ...
                                            <div><input type='hidden' id='tujuanKunj' name='tujuanKunj' value='0'></div>
                                            ...
                                            <div id="divRujukan">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                                        <input type="text" class="form-control" id="txtppkasalrujukan" placeholder="ketik kode atau nama ppk asal rujukan min 3 karakter" value="RSU PADANG PANJANG" readonly>
                ...
                <form role="form" method="post" action="#" onSubmit="return false">
                    <div class="box-body">
                        ...
                        <a href="#" onClick="print_reg_rajal()" class="btn btn-success btn-block">
                            <i class="fa fa-print"></i> <b>Cetak Registrasi Rawat Inap</b></a>
                        <a href="#" onClick="print_surat_reg_rajal()" class="btn btn-success btn-block">
                            <i class="fa fa-print"></i> <b>Surat Registrasi Rawat Inap</b></a>
                        <a href="#" onClick="print_surat_masuk_ranap()" class="btn btn-success btn-block">
                            <i class="fa fa-print"></i> <b>Surat Masuk Rawat Inap</b></a>
                        <?php
                        // echo $tgl_jaminan;
                        // if ($jkn == 1) {
                            if (!empty($no_jaminan)) {
                                if(empty($tgl_jaminan)||$tgl_jaminan=="0000-00-00") {
                                    $t=explode(' ',$tgl_masuk);
                                    $tgl_jaminan=$t[0];
                                }
                        ?>
                                <!-- <a href="<?= base_url() . "mr_registrasi.php/registrasi/sep/" . $no_jaminan ."/".$tgl_jaminan?>" target="_blank" class="btn btn-warning btn-block">
                        ...
                        <a href="#" onClick="print_gelang()" class="btn btn-warning btn-block">
                            <i class="fa fa-print"></i> <b>Cetak Gelang</b></a>
                        <a href="#" onClick="new_reg_rajal()" class="btn btn-primary btn-block">
                            <i class="fa fa-edit"></i> <b>Registrasi Rawat Inap Baru</b></a>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-lg" style="overflow-y: initial !important">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title" id="headRujukan">Surat Perintah Rawat Inap</h3>
            </div>
            <div class="modal-body">
                    ...
                    <form action="#"  class="form-horizontal" id="formkontrol">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="input-group">
                                    <select name="poliKontrol" id="poliKontrol" class="form-control select2" onchange="dokterKontrol()" style="width:100%"></select>
                                    <span class="input-group-btn">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                <select name="kodeDokter" id="kodeDokter" class="form-control selec2" style="width:100%"></select>
                                    <span class="input-group-btn">
...
<div class="modal fade" id="editsep" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="overflow:hidden;">
    <div class="modal-dialog modal-lg" style="overflow-y: initial !important;  max-height:85%">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">×</button>
                <h3 class="modal-title" id="headRujukan">Edit SEP Rawat Inap</h3>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" id="theform" style="font-size:12px">
                    <div class="row">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <!--input type="text" class="form-control ui-autocomplete-input" id="txtnmDokter" placeholder="ketik nama dokter Yang menangini">
                                        <input type="hidden" id="kodeDokter" value=""-->
                                        <select name="dpjpLayan" id="e-dpjpLayan" class="form-control dpjpLayan select2" style="width: 100%;"></select>
                                        <span class="text-error"></span>
                                    </div>
                                </div>
                ...
                <div id="layanan">
                    <form class="form-horizontal" name="upddatelayanan" id="updatelayanan">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                <div class="input-group">
                                    <select name="uid_ruang" id="uid_ruang" class="form-control" style="width: 100%;">
                                    <option value=""></option>
                                    <?php 
                                    foreach ($poli as $p) {
                                        ?>
...
<script type="text/javascript">
    ...
    function print_gelang() {
        var nomr = '<?php echo $nomr ?>';
        var url = '<?php echo base_url() . 'mr_registrasi.php/registrasi/cetakGelang?kode=' ?>' + nomr;
        openInNewTab(url);
    }

    function print_reg_rajal() {
        var reg_unit = '<?php echo encrypt_decrypt('encrypt', $reg_unit, true) ?>';
        var url = '<?php echo base_url() . 'mr_registrasi.php/registrasi/cetakRegRanap?kode=' ?>' + reg_unit;
        openInNewTab(url);
    }

    function print_surat_reg_rajal() {
        var reg_unit = '<?php echo $reg_unit ?>';
        var url = '<?php echo base_url() . 'mr_registrasi.php/registrasi/cetakSuratRegRanap?kode=' ?>' + reg_unit;
        openInNewTab(url);
    }

    function print_surat_masuk_ranap() {
        var reg_unit = '<?php echo $reg_unit ?>';
        var url = '<?php echo base_url() . 'mr_registrasi.php/registrasi/cetakSuratMasukRanap?kode=' ?>' + reg_unit;
        openInNewTab(url);
    }
