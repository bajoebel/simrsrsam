        ...
        <div class="col-xs-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <div class="row">
                        <div class="col-md-8">
                            <h3 class="box-title">Pasien DPO</h3>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <button class="btn btn-primary btn-sm" onclick="cariPasienDPO(0)">Search</button>
                                </span>
                            </div>
                        </div>
                        <div class="col-md-1">
...
<script type="text/javascript">
    ...
    function cari_pasien(start) {
        ...
        url = "<?php echo base_url() . "mr_registrasi.php/atm/data?q="; ?>" + search + "&start=" + start + "&poly=" + poly+ "&limit=" + limit;
        //alert(url);
        console.log(url);
        $.ajax({
            url: url,
            ...
            success: function(data) {
                ...
                for (let index = 0; index < data.data.length; index++) {
                    ...
                    tabel+="<tr>"+
                        "<td>"+start+"</td>"+
                        "<td>"+data.data[0].nomr+"</td>"+
                        "<td>"+data.data[0].no_ktp+"</td>"+
                        "<td>"+data.data[0].nama_pasien+"</td>"+
                        "<td>"+data.data[0].nama_ruang+"</td>"+
                        "<td>"+data.data[0].tgl_masuk+"</td>"+
                        "<td>"+data.data[0].rujukan+"</td>"+
                        "<td>"+data.data[0].label_antrian+"."+data.data[0].nomor_antrian+"</td>"+
                        "<td>"+data.data[0].namaDokterJaga+"</td>"+
                        "<td>"+data.data[0].cara_bayar+"</td>"+
                        "<td>"+data.data[0].tgl_masuk+"</td>"+
                        "<td>"+data.data[0].no_bpjs+"</td>";
                    if(parseInt(data.data[0].terdaftar)>0){
                        tabel+="<td><button class=\"btn btn-success btn-xs\"><span class=\"fa fa-check\"></span></button></td>"+
                        "</tr>";
                    }else{
                        tabel+="<td><a href='"+base_url+"atm/pendaftaran/"+data.data[0].idx+"' class='btn btn-danger btn-xs' >Aprove</button></td>"+
                        "</tr>";
                    }
