...
<tr>
<td>No.MR</td><td>:</td><td style='font-size:13px;'>&nbsp; <?php echo $pas['nomr'] ?></td>
</tr>
<tr>
<td>Nama</td><td>:</td><td>&nbsp; <?php echo $pas['nama'] ?></td>
</tr>
<tr>
<td style='width:70px;'>TGL. Lahir</td><td>:</td><td>&nbsp; <?php echo date("d-m-Y",strtotime($pas['tgl_lahir'])) ?></td>
</tr>
<tr>
...
<tr>
<td style='vertical-align:top;font-size:12px;font-weight:bold;font-family:arial;'><?php echo $pas['alamat'].", ".$pas['nama_kab_kota'] ?>
</td>
</tr>
</table>
