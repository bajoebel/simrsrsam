...
<td>
   <table align="left" id='tbl_rs' border=0>
        ...
        <tr>
            ...
            <td width="243" style='border-bottom:dashed thin #000;'>: <?php echo $data['kir'] ?></td>
            <td width="65">&nbsp;</td>
		...
		<tr>
            ...
            <td style='font-weight:bold;font-size:18px'>: <?php echo $idx ?></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td style='border-bottom:dashed thin #000;'></td>
        </tr>
        <tr>
            ...
            <td valign="top">: <?php echo $data['pasien'] ?> - No.MR : <?php echo $data['nomr'] ?></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
