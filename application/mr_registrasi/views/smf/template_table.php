                ...
                <div class="box-header with-border">
                    ...
                    <div class="col-lg-6 col-xs-12 mb-1">
                        <div class="input-group input-group-sm">
                            <input type="text" id="txtKeyword" class="form-control" placeholder="Enter SMF" />
                    ...
                    <div class="box-body">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Nama SMF</label>
                                <input type="hidden" id="idx">
                                <input type="text" class="form-control" id="nama_smf">
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function getTable() {
        ...
        $.ajax({
            url: "<?php echo base_url() . 'smf/getView' ?>",
            type: "POST",
            data: formdata,
            beforeSend: function() {
                $('.loading').modal('show');
    ...
    function hapus(a) {
        ...
        if (x) {
            ...
            formdata['idx'] = a;
            $.ajax({
                url: "<?php echo base_url() . 'smf/hapus' ?>",
                type: "POST",
                data: formdata,
                dataType: "JSON",
                success: function(data) {
    ...
    function simpan() {
        ...
        formdata['nama_smf'] = $('#nama_smf').val();

        if (formdata['nama_smf'] == "") {
            alert('Ops. Nama SMF harus di isi.');
            $('#nama_smf').focus();
        } else {
            $.ajax({
                url: "<?php echo base_url() . 'smf/simpan' ?>",
                type: "POST",
                data: formdata,
                dataType: "JSON",
                success: function(data) {
