    ...
    <table class="bordered">
        ...
        <tbody>
            <tr>
                <td>1</td>
                <td>Selisih Bayar</td>
                <td align="right"><?= number_format($tarif_selisih_bayar,0,',','.') ?></td>
            </tr>
            ...
            <tr>
                ...
                <td align="right" style="font-weight: bolder;"><?php echo number_format($tarif_selisih_bayar,0,',','.') ?></td>
            </tr>
            <tr>
                <td colspan="3">Terbilang : <span id="terbilang"></span></td>
            </tr>
        </tbody>
        <tfoot>
            <tr>
                <td colspan="3"><em>Kwitansi ini sebagai alat bukti pembayaran yang sah.</em></td>
            </tr>
        </tfoot>
    </table>
...
document.getElementById('terbilang').innerHTML = '#' + terbilangnya('<?= $tarif_selisih_bayar ?>') + ' #';
