...
$(document).ready(function () { 
    ...
    $('#btnTambah').click(function(){
        var url = '<?php echo base_url() ?>kasir.php/kwitansi_umum/tambah';
    ...
    $('#btnKeyword').click(function(){
        var a = $("#keywords").val();
        $.ajax({
            url         : "<?php echo base_url().'kasir.php/kwitansi_umum/getView' ?>",
            type        : "POST",
            data        : {sLike:a},
            beforeSend  : function(){
            ...
            success     : function(data){
                ...
                $('tr.resultDat').each(function(){
                    ...
                    console.log(a);
                    $.ajax({
                        url         : "<?php echo base_url().'kasir.php/kwitansi_umum/cekRetur' ?>",
                        type        : "POST",
                        data        : {no_kwitansi:a},
                        dataType    : "JSON",
                        success     : function(data){
...
function printLampiran(a,b,c){
    ...
    $.ajax({
        url : "<?php echo base_url().'kasir.php/kwitansi_umum/getLampiranKwitansi' ?>",
        type : "POST",
        data : {no_kwitansi:a},
        beforeSend  : function(){
...
function simpanRetur(){
    ...
    if(a==""){
        ...
        if(x){
            $.ajax({
                url         : "<?php echo base_url().'kasir.php/kwitansi_umum/returKwitansi' ?>",
                type        : "POST",
