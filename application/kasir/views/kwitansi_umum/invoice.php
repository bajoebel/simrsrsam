...
<body id="A4">
    ...
    <table class="bordered">
        <thead>
            <th width="50px">No</th>
            <th width="100px">Item Transaksi</th>
        ...
        <tbody>
            ...
            <tr>
                <td colspan="3" align="right" style="font-weight: bolder;">Total Tagihan</td>
                <td align="right" style="font-weight: bolder;"><?php echo number_format($total_tagihan,0,',','.') ?></td>
            </tr>
            <tr>
                <td colspan="3" align="right" style="font-weight: bolder;">Biaya Lainnya</td>
            ...
            <tr>
                <td colspan="4">Terbilang : <span id="terbilang"></span></td>
            </tr>
        </tbody>
        <tfoot>
            <tr>
