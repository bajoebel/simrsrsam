        ...
        <form id="form1" method="post">
            <div class="widget-box">
                <table class="table table-striped transObat">
                    ...
                    <tr>
                        <td width="150px">Pasien/Kelamin</td>
                        ...
                        <td>&nbsp;</td>
                        <td width="200px">Biaya Lainnya</td>
                        <td align="center" width="10px">:</td>
                        <td>
                            <div class="input-group-sm">
...
$(document).ready(function(){
    ...
    $('#btnKembali').click(function(){
        var url = '<?php echo base_url().'kasir.php/kwitansi_umum' ?>';
    ...
    $('#simpan_kwitansi').click(function(){
        ...
        $.ajax({
            url         : "<?php echo base_url().'kasir.php/kwitansi_umum/simpan_kwitansi' ?>",
            type        : "POST",
            data        : formItems,
            dataType    : "JSON",
            beforeSend  : function(){
            ...
            success     : function(data){
                if(data.code==200){
                    ...
                    $('#tgl_keluar').val("");
                    $('#getData').html("<tr><td colspan=4>Data Item masih kosong<td/></tr>");
                    window.open('<?php echo base_url().'kasir.php/kwitansi_umum/cetak_kwitansi?kode=' ?>'+data.message);
                }else{
                    alert(data.message);
                }
    ...
    function getTabel(a){
        $.ajax({
            url         : "<?php echo base_url().'kasir.php/kwitansi_umum/getkwitansi' ?>",
            type        : "POST",
            data        : {sText:a},
            beforeSend  : function(){
    ...
    $('#sKeyword').keyup(function(ev){
        ...
        if(event==13){
            var a = $('#sKeyword').val();
            $.ajax({
                url         : "<?php echo base_url().'kasir.php/kwitansi_umum/getPasien' ?>",
                type        : "POST",
                data        : {keyword:a},
                beforeSend  : function(){
    ...
    $('#keywordButton').click(function(){
        ...
        if(a==""){
            ...
            $.ajax({
                url         : "<?php echo base_url().'kasir.php/kwitansi_umum/getPasienDetail' ?>",
                type        : "POST",
                data        : {sText:a},
                dataType    : "JSON",
                success     : function(data){
...
function getTotalTagihan(a){
    $.ajax({
        url         : "<?php echo base_url().'kasir.php/kwitansi_umum/getTotalTagihan' ?>",
        type        : "POST",
        data        : {sText:a},
        beforeSend  : function(){
