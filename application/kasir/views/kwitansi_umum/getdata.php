...
?>
    <tr data-id="<?php echo $x['no_kwitansi']; ?>" class="resultDat">
        ...
        <td class="rataTengah">
            <button class="btn btn-danger" type="button" onclick="window.open('<?php echo base_url().'kasir.php/kwitansi_umum/cetak_kwitansi?kode='.$x['no_kwitansi'] ?>');" title="Cetak Kwitansi">
