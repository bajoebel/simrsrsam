...
<body id="A4">
    ...
    <table width="100%" border="0">
        <tr>
            ...
            <td><?php echo '<b>'.getPasienPulangByRegUnit($kode_item)['id_daftar'].'</b>' ?></td>
            <td>No Reg Unit</td>
            <td align="center">:</td>
        ...
        <tr>
            <td>No.MR</td>
            <td align="center">:</td>
            <td><?php echo getPasienPulangByRegUnit($kode_item)['nomr'] ?></td>
            <td>Unit</td>
            <td align="center">:</td>
            <td><?php echo getPasienPulangByRegUnit($kode_item)['nama_ruang'] ?></td>
        </tr>
        <tr>
            <td>Pasien</td>
            <td align="center">:</td>
            <td><?php echo getPasienPulangByRegUnit($kode_item)['nama_pasien'] ?></td>
            <td>Jenis Layanan</td>
            <td align="center">:</td>
            <td><?php echo getPasienPulangByRegUnit($kode_item)['jns_layanan'] ?></td>
        </tr>
    </table>
