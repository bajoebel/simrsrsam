...
<tr>
    ...
    <td style="text-align: center;"><?php echo $x['nama_pasien']; ?></td>
    <td style="text-align: center;"><?php echo $x['cara_bayar']; ?></td>
    <td style="text-align: center;"><?php echo $x['nama_dpjp']; ?></td>
