...
<body id="A4">
    ...
    <table width="100%" border="0">
        ...
        <tr>
            <td align="center">
                <?php echo ($cara_bayar=="ALL") ? "Semua Cara Bayar" : "Cara Bayar : " . getCaraBayarByID($cara_bayar) ?>
            </td>
        </tr>
        <tr>
...
$(document).ready(function(){
    ...
    function getTable(){
        ...
        var c = "<?php echo $cara_bayar ?>";
        $.ajax({
            url         : "<?php echo base_url().'kasir.php/laporan/get_print_data' ?>",
            type        : "POST",
            data        : {tAwal:a,tAkhir:b,cara_bayar:c},
            beforeSend  : function(){
