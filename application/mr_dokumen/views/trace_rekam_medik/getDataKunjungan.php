...
<tr>
    ...
    <td class="rataTengah">
        <a href="#" class="btn btn-danger" onclick="pilihKunjungan('<?php echo $x['id_daftar'] ?>','<?php echo $x['nomr'] ?>','<?php echo $x['nama'] ?>','<?php echo $x['id_ruang'] ?>','<?php echo getRuangByID($x['id_ruang']) ?>')">
