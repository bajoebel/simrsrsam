...
<section class="content container-fluid">    
    <div class="alert alert-danger alert-dismissible">
        ...
        Data KetidakLengkapan Pengisian Catatan Medis
    </div>
    <div class="row">
        <div class="col-xs-12">
...
$(document).ready(function () { 
    ...
    $('#btnTambah').click(function(){
        var url = '<?php echo base_url().'mr_dokumen.php/klpcm/tambah' ?>';
    ...
    $('#keyword').keypress(function(ev){
        ...
        if (keycode == '13') {
            $.ajax({
                url         : "<?php echo base_url().'mr_dokumen.php/klpcm/getView' ?>",
                type        : "POST",
                data        : {sLike:$(this).val()},
                beforeSend  : function(){
...
function edit(a){
    var url = '<?php echo base_url().'mr_dokumen.php/klpcm/tambah/' ?>'+a;
    window.location.href = url;
}
function hapus(a){
    ...
    if(x){
        $.ajax({
            url         : "<?php echo base_url().'mr_dokumen.php/klpcm/hapus' ?>",
            type        : "POST",
            data        : {idx:a},
            dataType    : "JSON",
            success     : function(data){
