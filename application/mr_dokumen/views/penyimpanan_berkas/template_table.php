...
$(document).ready(function () { 
    ...
    $('#btnTambah').click(function(){
        var url = '<?php echo base_url().'mr_dokumen.php/penyimpanan_berkas/tambah' ?>';
    ...
    $('#keyword').keypress(function(ev){
        ...
        if (keycode == '13') {
            $.ajax({
                url         : "<?php echo base_url().'mr_dokumen.php/penyimpanan_berkas/getView' ?>",
                type        : "POST",
                data        : {sLike:$(this).val()},
                beforeSend  : function(){
...
function edit(a){
    var url = '<?php echo base_url().'mr_dokumen.php/penyimpanan_berkas/tambah/' ?>'+a;
    window.location.href = url;
}
function hapus(a){
    ...
    if(x){
        $.ajax({
            url         : "<?php echo base_url().'mr_dokumen.php/penyimpanan_berkas/hapus' ?>",
            type        : "POST",
            data        : {idx:a},
            dataType    : "JSON",
            success     : function(data){
