...
<body id="A4">
    ...
    <table width="100%" border="0">
        <tr>
            <td align="center" style="font-size: 1.2em;font-weight: bolder;">Rekap Penyimpanan Berkas</td>
        </tr>
        <tr>
...
$(document).ready(function(){
    ...
    function getTable(){
        var a = "<?php echo $idx ?>";
        $.ajax({
            url         : "<?php echo base_url().'mr_dokumen.php/penyimpanan_berkas/get_print_data' ?>",
            type        : "POST",
            data        : {kode:a},
            beforeSend  : function(){
