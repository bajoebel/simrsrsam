                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="col-md-2">
                                    ...
                                    <input type="text" name="dari" id="dari" class="form-control tanggal" maxlength="4" data-inputmask="'alias': 'decimal', 'digits': 0, 'digitsOptional': false, 'placeholder': 'yyyy'" value="<?= date('Y') ?>">
                                </div>
                                <div class="col-md-2">
                                    <label> Sampai Tahun </label>
                                    <input type="text" name="sampai" id="sampai" class="form-control tanggal" maxlength="4" data-inputmask="'alias': 'decimal','digits': 0, 'digitsOptional': false, 'placeholder': 'yyyy'" value="<?= date('Y') ?>">
                                </div>
                                <div class="col-md-2">
...
<script type="text/javascript">
    ...
    function view_rekapitulasi() {
        ...
        var header = "";
        var url = base_url + "/rekapitulasi/datatahunan?dari=" + dari + "&sampai=" + sampai + "&group=" + group + "&layanan=" + layanan;
        console.log(url);
        $.ajax({
            url: url,
            type: 'GET',
            ...
            success: function(data) {
                ...
                if (group == "") {
                    for (i = 0; i < jmlData; i++) {
                        ...
                        var tgl = data["content"][i]["tahunkunjungan"];
                        //console.log(tgl); 
