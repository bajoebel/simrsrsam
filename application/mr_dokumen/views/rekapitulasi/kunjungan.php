                    ...
                    <form action="#" class="form-horizontal" method="get">
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="col-md-2">
                                    <label> Tanggal </label>
                                    <input type="text" name="dari" id="dari" class="form-control tanggal" value="<?= date('Y-m-d') ?>">
                                </div>
                                <div class="col-md-2">
                                    <label> Sampai Tanggal </label>
                                    <input type="text" name="sampai" id="sampai" class="form-control tanggal" value="<?= date('Y-m-d') ?>">
                                </div>
                                <div class="col-md-2">
    ...
    function view_rekapitulasi() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (group == "") {
                    for (i = 0; i < jmlData; i++) {
                        var str = data["content"][i]["tgl_kunjungan"];
                        var t_tgl = str.split("-");
                        var tgl = t_tgl[2] + " " + bulan[parseInt(t_tgl[1])] + " " + t_tgl[0];
                        //console.log(tgl); 
                    ...
                    for (i = 0; i < jmlData; i++) {
                        ...
                        var t_tgl = str.split("-");
                        var tgl = t_tgl[2] + " " + bulan[parseInt(t_tgl[1])] + " " + t_tgl[0];
                        list_data += "<tr><td>" + tgl + "</td><td>" + data["content"][i]["dalam_kota"] + "</td>" +
                            "<td>" + data["content"][i]["luar_kota"] + "</td><td>" + data["content"][i]["jml_kunjungan"] + "</td></tr>";
                    }
