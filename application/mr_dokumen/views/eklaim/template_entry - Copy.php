                        ...
                        <select name="cob_cd" id="cob_cd" class="form-control" style="width: 320px;">
                            ...
                            <tr class="rowItem">
                                ...
                                <td class="inputItem">
                                    <label class="xlnk">
                                        Masuk :
                                        <input class="form-control tanggal" type="text" id="tgl_masuk" placeholder="yyyy-mm-dd" style="width: 120px;display: inline-block;" />
                                    </label>
                                    <label class="xlnk">
                                        Pulang :
                                        <input class="form-control tanggal" type="text" id="tgl_pulang" placeholder="yyyy-mm-dd" style="width: 120px;display: inline-block;" />
                                    </label>
                                </td>
                                <td class="labelItem">Umur</td>
                                <td class="inputItem">
                                    <span id="umur">0</span> Hari
                                </td>
                            </tr>
                            ...
                            <tr class="rowItem">
                                ...
                                <td class="inputItem">
                                    <input type="text" name="los" id="los" class="form-control inputmask rataKanan" style="width: 100px" data-inputmask="'alias': 'decimal', 'groupSeparator': ',', 'autoGroup': true, 'digits': 0, 'digitsOptional': false, 'placeholder': '0'"/>
                                </td>
                            ...
                            <tr>
                                <td colspan="4" >
                                    <input type="text" id="txtDiagPanelValue" class="form-control" />
                                    <input type="text" id="txtDiagPanelAttr" class="form-control" />
                                </td>
                            </tr>
                            <tr class="rowItem">
                            ...
                            <tr class="rowItem">
                                <td colspan="4" id="rowProsedure"></td>
                            </tr>
                            <tr class="rowItem">
...
var icd_kode =  ui.item['label']
var icd_desk =  ui.item['value']

var rowItem = $('#rowDiagnosa');
var nRowsItem = $('div.divRowItems').length;
var div = '<div class="divRowItems" id="'+ui.item['label']+'">';
    div += '<div style="display: inline-table;">'+ui.item['value']+'</div>';
    div += '<div style="display: inline-table;border:1px solid #c1c1c1;padding: 5px;margin: 5px">'+ui.item['label']+'</div>';

if (nRowsItem == 0) {
    div += '<div style="display: inline-table;">Primer</div>';
    $('#txtDiagPanelValue').val(icd_kode);
    $('#txtDiagPanelAttr').val(icd_kode+'^'+icd_desk);
}else{
    var DiagValue = $('#txtDiagPanelValue').val();
        DiagValue += '|'+icd_kode;
    var DiagAttr = $('#txtDiagPanelAttr').val();
        DiagAttr += '|'+icd_kode+'^'+icd_desk;

    $('#txtDiagPanelValue').val(DiagValue);
    $('#txtDiagPanelAttr').val(DiagAttr);
    div += '<div style="display: inline-table;">Sekunder</div>';
}
    div += '<div style="display: inline-table;margin-left:10px">';
    div += '<button onclick="icd10delete(\''+ui.item['label']+'\',this)" class="btn btn-danger">Hapus</button>';
    div += '</div>';
    div += '</div>';
...
function addCell(span, val) {
    var span = document.createElement('span');
    span.innerHTML = span;
    span.appendChild(val)
}

function addRow(div, val_1, val_2, val_3) {
