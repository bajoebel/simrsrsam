<section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree" id="menu">
        ...
        <li class="<?php echo $nav_1; ?>">
            <a href="<?php echo base_url() . 'mr_dokumen.php/dashboard' ?>">
                <i class="fa fa-home"></i> <span>Home</span></a>
        </li>

        <li class="treeview <?php echo $nav_2; ?>">
            <a href="#"><i class="fa fa-list"></i> <span>MR Dokumen</span>
                <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                </span>
            </a>
            <ul class="treeview-menu">
                <li><a href="<?php echo base_url() . 'mr_dokumen.php/status_kembali' ?>">
                        <i class="fa fa-circle-o text-red"></i>Penerimaan Status Kembali</a></li>
                <li><a href="<?php echo base_url() . 'mr_dokumen.php/klpcm' ?>">
                        <i class="fa fa-circle-o text-red"></i>Pemeriksaan KLPCM</a></li>
                <li><a href="<?php echo base_url() . 'mr_dokumen.php/pengembalian_berkas' ?>">
                        <i class="fa fa-circle-o text-red"></i>Pengembalian Berkas</a></li>
                <li><a href="<?php echo base_url() . 'mr_dokumen.php/penyimpanan_berkas' ?>">
                        <i class="fa fa-circle-o text-red"></i>Penyimpanan Berkas</a></li>
            </ul>
        </li>
        <!-- -->
        <li class="treeview <?php echo $nav_3; ?>">
            <a href="#"><i class="fa fa-list"></i> <span>Entry Data SIRS</span>
                <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                </span>
            </a>
            <ul class="treeview-menu">
                <li><a href="<?php echo base_url() . 'mr_dokumen.php/informasi_pasien_keluar' ?>">
                        <i class="fa fa-circle-o text-red"></i>Informasi Pasien Keluar</a></li>
            </ul>
        </li>
        <li class="treeview <?php echo $nav_4; ?>">

            <a href="#"><i class="fa fa-list"></i> <span>Trace Rekam Medik</span>
                <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                </span>
            </a>
            <ul class="treeview-menu">
                <li><a href="<?php echo base_url() . 'mr_dokumen.php/trace_rekam_medik' ?>">
                        <i class="fa fa-circle-o text-red"></i>Trace Rekam Medik</a></li>
                <li><a href="<?php echo base_url() . 'mr_dokumen.php/online' ?>">
                        <i class="fa fa-circle-o text-red"></i>Trace Rekam Medik Pasien Online</a></li>
            </ul>
        </li>
        <li class="treeview <?php echo $nav_5; ?>">
            <a href="#"><i class="fa fa-list"></i> <span>SIMRS - E-Klaim</span>
                <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                </span>
            </a>
            <ul class="treeview-menu">
                <li><a href="<?php echo base_url() . 'mr_dokumen.php/eklaim' ?>">
                        <i class="fa fa-circle-o text-red"></i>Coding/Grouping</a></li>
            </ul>
        </li>
        <li class="treeview <?php echo $nav_6; ?>">
            <a href="#">
                <i class="fa fa-print"></i> <span>Laporan SIRS</span>
                <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                </span>
            </a>
            <ul class="treeview-menu">
                <li class="treeview">
                    <a href="#"><i class="fa fa-circle-o text-red"></i> IGD
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/igd/kunjungan_bala' ?>">
                                <i class="fa fa-circle-o text-green"></i> Kunjungan Baru-Lama</a></li>
                        <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/igd/kunjungan_caba' ?>">
                                <i class="fa fa-circle-o text-green"></i> Kunjungan /Cara Bayar</a></li>
                        <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/igd/kunjungan_pelayanan' ?>">
                                <i class="fa fa-circle-o text-green"></i> Kunjungan /Pelayanan</a></li>
                        <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/igd/top_teen' ?>">
                                <i class="fa fa-circle-o text-green"></i> Top 10 Penyakit</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#"><i class="fa fa-circle-o text-red"></i> Rawat Jalan
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/rajal/kunjungan_bala' ?>">
                                <i class="fa fa-circle-o text-green"></i> Kunjungan Baru-Lama</a></li>
                        <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/rajal/kunjungan_caba' ?>">
                                <i class="fa fa-circle-o text-green"></i> Kunjungan /Cara Bayar</a></li>
                        <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/rajal/kunjungan_pelayanan' ?>">
                                <i class="fa fa-circle-o text-green"></i> Kunjungan /Pelayanan</a></li>
                        <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/rajal/kunjungan_poli' ?>">
                                <i class="fa fa-circle-o text-green"></i> Kunjungan Poliklinik</a></li>
                        <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/rajal/top_teen' ?>">
                                <i class="fa fa-circle-o text-green"></i> Top 10 Penyakit</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#"><i class="fa fa-circle-o text-red"></i> Rawat Inap
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/ranap/bor' ?>">
                                <i class="fa fa-circle-o text-green"></i> Bed Occupancy Rate</a></li>
                        <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/ranap/alos' ?>">
                                <i class="fa fa-circle-o text-green"></i> Average Long Of Stay</a></li>
                        <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/ranap/toi' ?>">
                                <i class="fa fa-circle-o text-green"></i> Turn Over Interval</a></li>
                        <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/ranap/bto' ?>">
                                <i class="fa fa-circle-o text-green"></i> Bed Turn Over</a></li>
                        <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/ranap/ndr' ?>">
                                <i class="fa fa-circle-o text-green"></i> Net Death Rate</a></li>
                        <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/ranap/gdr' ?>">
                                <i class="fa fa-circle-o text-green"></i> Gross Death Rate</a></li>
                        <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/ranap/hari_rawat' ?>">
                                <i class="fa fa-circle-o text-green"></i> Hari Rawat</a></li>
                        <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/ranap/pasien_keluar' ?>">
                                <i class="fa fa-circle-o text-green"></i> Jumlah Pasien Keluar</a></li>
                        <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/ranap/pasien_masuk' ?>">
                                <i class="fa fa-circle-o text-green"></i> Jumlah Pasien Masuk</a></li>
                        <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/ranap/mati_lebih_48' ?>">
                                <i class="fa fa-circle-o text-green"></i> Kematian > 48 Jam</a></li>
                        <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/ranap/mati_kurang_48' ?>">
                                <i class="fa fa-circle-o text-green"></i> Kematian < 48 Jam</a> </li> <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/ranap/pasien_pelayanan' ?>">
                                        <i class="fa fa-circle-o text-green"></i> Jml.Pasien /Pelayanan</a></li>
                        <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/ranap/pasien_ruang_rawat' ?>">
                                <i class="fa fa-circle-o text-green"></i> Jml.Pasien /Ruang Rawat</a></li>
                        <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/ranap/pasien_hidup_mati' ?>">
                                <i class="fa fa-circle-o text-green"></i> Jml.Pasien Hidup & Mati</a></li>
                        <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/ranap/kegiatan_pelayanan' ?>">
                                <i class="fa fa-circle-o text-green"></i> Kegiatan Pelayanan</a></li>
                        <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/ranap/kunjungan_caba' ?>">
                                <i class="fa fa-circle-o text-green"></i> Kunjungan /Cara Bayar</a></li>
                        <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/ranap/kunjungan_pelayanan' ?>">
                                <i class="fa fa-circle-o text-green"></i> Kunjungan /Pelayanan</a></li>
                        <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/ranap/lama_rawat' ?>">
                                <i class="fa fa-circle-o text-green"></i> Lama Rawat</a></li>
                        <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/ranap/morbodotas_sl' ?>">
                                <i class="fa fa-circle-o text-green"></i> Morbodotas Mortalitas (SL)</a></li>
                        <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/ranap/morbodotas' ?>">
                                <i class="fa fa-circle-o text-green"></i> Morbodotas Mortalitas</a></li>
                        <li><a href="<?php echo base_url() . 'mr_dokumen.php/sirs/ranap/top_teen' ?>">
                                <i class="fa fa-circle-o text-green"></i> Top 10 Penyakit</a></li>
                    </ul>
                </li>
        ...
        <li class="treeview <?php echo $nav_7; ?>">
            <a href="#"><i class="fa fa-list"></i> <span>Rekapitulasi Kunjungan</span>
                <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                </span>
            </a>
            <ul class="treeview-menu">
                <li><a href="<?php echo base_url() . 'mr_dokumen.php/rekapitulasi/kunjungan' ?>">
                        <i class="fa fa-circle-o text-red"></i>Harian</a></li>
                <li><a href="<?php echo base_url() . 'mr_dokumen.php/rekapitulasi/bulanan' ?>">
                        <i class="fa fa-circle-o text-red"></i>Bulanan</a></li>
                <li><a href="<?php echo base_url() . 'mr_dokumen.php/rekapitulasi/tahunan' ?>">
                        <i class="fa fa-circle-o text-red"></i>Tahunan</a></li>
            </ul>
        </li>
    </ul>
</section>