...
<body id="A4">
    ...
    <table width="100%" border="0">
        <tr>
            <td align="center" style="font-size: 1.2em;font-weight: bolder;">Rekap Pengembalian Berkas</td>
        </tr>
        <tr>
            <td align="left">Kode Rekap : <?php echo $idx ?></td>
        </tr>
        <tr>
            <td align="left">Tgl. Rekap : <?php echo date('d-m-Y H:i',strtotime($tanggal)) ?></td>
        </tr>
    </table>
    ...
    <table class="bordered">
        <thead>
            <tr>
                ...
                <th>Nama Pasien</th>
                <th width="150px">Lokasi Layanan</th>
                <th width="80px">Tgl<br/>Proses</th>
                <th>Keterangan</th>
            </tr>
        </thead>
...
$(document).ready(function(){
    ...
    function getTable(){
        var a = "<?php echo $idx ?>";
        $.ajax({
            url         : "<?php echo base_url().'mr_dokumen.php/pengembalian_berkas/get_print_data' ?>",
            type        : "POST",
            data        : {kode:a},
            beforeSend  : function(){
