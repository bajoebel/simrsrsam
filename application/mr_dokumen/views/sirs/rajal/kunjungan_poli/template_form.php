...
$(document).ready(function () { 
    ...
    $('#btnKeyword').click(function(){
        a = $('#Tahun').val();
        $.ajax({
            url         : "<?php echo base_url().'mr_dokumen.php/sirs/rajal/kunjungan_poli/getReport' ?>",
            type        : "POST",
            data        : {Tahun:a},
            beforeSend  : function(){
    ...
    $('#btnCetak').click(function(){
        a = $('#Tahun').val();
        var url = '<?php echo base_url().'mr_dokumen.php/sirs/rajal/kunjungan_poli/cetak?thn=' ?>'+a;
        openInNewTab(url);        
    });
});
