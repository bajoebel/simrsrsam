...
<body id="A4">
    ...
    <table width="100%" border="0">
        ...
        <tr>
            <td align="center">KUNJUNGAN BULANAN PER PELAYANAN RAWAT JALAN TAHUN <?php echo $thn ?></td>
        </tr>
        <tr>
            <td align="center"><hr /></td>
        </tr>
...
function getTable(){
    var a = "<?php echo $thn ?>";
    $.ajax({
        url         : "<?php echo base_url().'mr_dokumen.php/sirs/rajal/kunjungan_pelayanan/getdata' ?>",
        type        : "POST",
        data        : {thn:a},
        beforeSend  : function(){
