...
$(document).ready(function () { 
    ...
    $('#btnKeyword').click(function(){
        a = $('#Tahun').val();
        $.ajax({
            url         : "<?php echo base_url().'mr_dokumen.php/sirs/rajal/kunjungan_bala/getReport' ?>",
            type        : "POST",
            data        : {Tahun:a},
            beforeSend  : function(){
                $('#getdata').html("<tr><td colspan=2><i class='fa fa-spin fa-refresh'></i> Loading... Please wait</td></tr>");
            },
    ...
    $('#btnCetak').click(function(){
        a = $('#Tahun').val();
        var url = '<?php echo base_url().'mr_dokumen.php/sirs/rajal/kunjungan_bala/cetak?thn=' ?>'+a;
        openInNewTab(url);        
    });
});
