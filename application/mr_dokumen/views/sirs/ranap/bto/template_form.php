            ...
            <div class="box box-success">
                <div class="box-body table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                <th rowspan="2" style="vertical-align: middle;">Ruang Ranap</th>
                                <th rowspan="2" style="vertical-align: middle;">Jml. TT</th>
                        ...
                        <tbody id="getdata">
                            <tr><td colspan="27">Data masih kosong</td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
...
$(document).ready(function () { 
    ...
    $('#btnKeyword').click(function(){
        ...
        b = $('#ranap').val();
        $.ajax({
            url         : "<?php echo base_url().'mr_dokumen.php/sirs/ranap/bto/getReport' ?>",
            type        : "POST",
            data        : {Tahun:a,ranap:b},
            beforeSend  : function(){
                $('#getdata').html("<tr><td colspan=27><i class='fa fa-spin fa-refresh'></i> Loading... Please wait</td></tr>");
            },
    ...
    $('#btnCetak').click(function(){
        a = $('#Tahun').val();
        b = $('#ranap').val();
        var url = '<?php echo base_url().'mr_dokumen.php/sirs/ranap/bto/cetak?thn=' ?>'+a+'&ranap='+b;
        openInNewTab(url);        
    });
});
