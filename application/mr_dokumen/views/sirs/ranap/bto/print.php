...
<body id="A4">
    ...
    <table width="100%" border="0">
        ...
        <tr>
            <td align="center">Bed Turn Over (BTO) Tahun <?php echo $thn ?></td>
        </tr>
        <tr>
            <td align="center"><hr /></td>
        </tr>
...
function getTable(){
    ...
    $.ajax({
        url         : "<?php echo base_url().'mr_dokumen.php/sirs/ranap/bto/getdata' ?>",
        type        : "POST",
        data        : {Tahun:a,ranap:b},
        beforeSend  : function(){
            $('#getdata').html("<tr><td colspan=15>Loading... Please wait</td></tr>");
        },
        success : function(data){
            $('#getdata').html(data);
        },
        error   : function(jqXHR,ajaxOption,errorThrown){
            $('#getdata').html("<tr><td colspan=15>Data tidak ditemukan</td></tr>");
