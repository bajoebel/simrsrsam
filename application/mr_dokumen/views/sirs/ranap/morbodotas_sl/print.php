...
<body id="A4">
    ...
    <table width="100%" border="0">
        ...
        <tr>
            <td align="center">Ranap - Morbodotas Mortalitas (Sebab Luar) <?php echo $thn ?></td>
        </tr>
        <tr>
            <td align="center"><hr /></td>
        </tr>
    ...
    <table class="bordered">
        <thead>
            <tr>
                ...
                <th rowspan="3" width="100px">No.Daftar terperinci</th>
                <th rowspan="3" width="100px">Golongan sebab penyakit</th>
                <th colspan="18">Jumlah Pasien Hidup dan Mati menurut Golongan Umur & Jenis Kelamin</th>
                <th colspan="2" rowspan="2" width="70px">Pasien Keluar (Hidup & Mati) Menurut Jenis Kelamin</th>
                <th rowspan="3" width="70px">Jumlah Pasien Keluar Hidup</th>
                <th rowspan="3" width="70px">Jumlah Pasien Keluar Mati</th>
            </tr>
            <tr>
...
function getTable(){
    var a = "<?php echo $thn ?>";
    $.ajax({
        url         : "<?php echo base_url().'mr_dokumen.php/sirs/ranap/morbodotas_sl/getdata' ?>",
        type        : "POST",
        data        : {thn:a},
        beforeSend  : function(){
            $('#getdata').html("<tr><td colspan=25>Loading... Please wait</td></tr>");
        },
        success : function(data){
            $('#getdata').html(data);
        },
        error   : function(jqXHR,ajaxOption,errorThrown){
            $('#getdata').html("<tr><td colspan=25>Data tidak ditemukan</td></tr>");
