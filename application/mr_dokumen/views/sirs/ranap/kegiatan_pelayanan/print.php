...
<body id="A4">
    ...
    <table width="100%" border="0">
        ...
        <tr>
            <td align="center">KEGIATAN PELAYANAN RAWAT INAP TAHUN <?php echo $thn ?></td>
        </tr>
        <tr>
            <td align="center"><hr /></td>
        </tr>
    ...
    <table class="bordered">
        <thead>
            <tr>
                ...
                <th rowspan="2">Lama<br/>Rawat</th>
                <th rowspan="2">Hari<br/>Rawat</th>
                <th colspan="4">Hari Rawat</th>
...
function getTable(){
    var a = "<?php echo $thn ?>";
    $.ajax({
        url         : "<?php echo base_url().'mr_dokumen.php/sirs/ranap/kegiatan_pelayanan/getdata' ?>",
        type        : "POST",
        data        : {thn:a},
        beforeSend  : function(){
            $('#getdata').html("<tr><td colspan=10>Loading... Please wait</td></tr>");
        },
