...
<body id="A4">
    ...
    <table width="100%" border="0">
        ...
        <tr>
            <td align="center">JUMLAH PASIEN BERDASARKAN RUANG RAWAT RAWAT INAP TAHUN <?php echo $thn ?></td>
        </tr>
        <tr>
            <td align="center"><hr /></td>
        </tr>
...
function getTable(){
    var a = "<?php echo $thn ?>";
    $.ajax({
        url         : "<?php echo base_url().'mr_dokumen.php/sirs/ranap/pasien_ruang_rawat/getdata' ?>",
        type        : "POST",
        data        : {thn:a},
        beforeSend  : function(){
