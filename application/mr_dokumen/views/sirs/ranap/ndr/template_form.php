                        ...
                        <thead>
                            <tr>
                                ...
                                <th colspan="24" style="text-align: center;">
                                    Jumlah Pasien Mati > 48 Jam (M) - Jumlah Pasien Keluar (Hidup + Mati) (K)
                                </th>
...
$(document).ready(function () { 
    ...
    $('#btnKeyword').click(function(){
        ...
        b = $('#ranap').val();
        $.ajax({
            url         : "<?php echo base_url().'mr_dokumen.php/sirs/ranap/ndr/getReport' ?>",
            type        : "POST",
    ...
    $('#btnCetak').click(function(){
        a = $('#Tahun').val();
        b = $('#ranap').val();
        var url = '<?php echo base_url().'mr_dokumen.php/sirs/ranap/ndr/cetak?thn=' ?>'+a+'&ranap='+b;
        openInNewTab(url);        
    });
});
