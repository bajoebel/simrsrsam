...
<body id="A4">
    ...
    <table width="100%" border="0">
        ...
        <tr>
            <td align="center">Average Long Of Stay (ALOS) Tahun <?php echo $thn ?></td>
        </tr>
        <tr>
            <td align="center"><hr /></td>
        </tr>
...
function getTable(){
    ...
    $.ajax({
        url         : "<?php echo base_url().'mr_dokumen.php/sirs/ranap/alos/getdata' ?>",
        type        : "POST",
        data        : {Tahun:a,ranap:b},
        beforeSend  : function(){
            $('#getdata').html("<tr><td colspan=26>Loading... Please wait</td></tr>");
        },
