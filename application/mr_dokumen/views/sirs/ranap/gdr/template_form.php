                        ...
                        <thead>
                            <tr>
                                ...
                                <th colspan="24" style="text-align: center;">
                                    Jumlah Pasien Mati (M) - Jumlah Pasien Keluar (Hidup + Mati) (K)
                                </th>
...
$(document).ready(function () { 
    ...
    $('#btnKeyword').click(function(){
        ...
        b = $('#ranap').val();
        $.ajax({
            url         : "<?php echo base_url().'mr_dokumen.php/sirs/ranap/gdr/getReport' ?>",
            type        : "POST",
    ...
    $('#btnCetak').click(function(){
        a = $('#Tahun').val();
        b = $('#ranap').val();
        var url = '<?php echo base_url().'mr_dokumen.php/sirs/ranap/gdr/cetak?thn=' ?>'+a+'&ranap='+b;
        openInNewTab(url);        
    });
});
