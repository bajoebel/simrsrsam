                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th colspan="12" style="text-align: center;">Jumlah Hari Perawatan</th>
                        ...
                        <tbody id="getdata">
                            <tr><td colspan="13">Data masih kosong</td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
...
$(document).ready(function () { 
    ...
    $('#btnKeyword').click(function(){
        ...
        b = $('#ranap').val();
        $.ajax({
            url         : "<?php echo base_url().'mr_dokumen.php/sirs/ranap/bor/getReport' ?>",
            type        : "POST",
    ...
    $('#btnCetak').click(function(){
        a = $('#Tahun').val();
        b = $('#ranap').val();
        var url = '<?php echo base_url().'mr_dokumen.php/sirs/ranap/bor/cetak?thn=' ?>'+a+'&ranap='+b;
        openInNewTab(url);        
    });
});
