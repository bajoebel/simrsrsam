...
$(document).ready(function () { 
    ...
    $('#btnKeyword').click(function(){
        a = $('#Tahun').val();
        $.ajax({
            url         : "<?php echo base_url().'mr_dokumen.php/sirs/ranap/mati_kurang_48/getReport' ?>",
            type        : "POST",
            data        : {Tahun:a},
            beforeSend  : function(){
    ...
    $('#btnCetak').click(function(){
        a = $('#Tahun').val();
        var url = '<?php echo base_url().'mr_dokumen.php/sirs/ranap/mati_kurang_48/cetak?thn=' ?>'+a;
        openInNewTab(url);        
    });
});
