...
$(document).ready(function () { 
    ...
    $('#btnKeyword').click(function(){
        a = $('#Tahun').val();
        $.ajax({
            url         : "<?php echo base_url().'mr_dokumen.php/sirs/igd/kunjungan_pelayanan/getReport' ?>",
            type        : "POST",
            data        : {Tahun:a},
            beforeSend  : function(){
    ...
    $('#btnCetak').click(function(){
        a = $('#Tahun').val();
        var url = '<?php echo base_url().'mr_dokumen.php/sirs/igd/kunjungan_pelayanan/cetak?thn=' ?>'+a;
        openInNewTab(url);        
    });
});
