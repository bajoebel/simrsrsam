...
class gdr extends CI_Controller{
    ...
    function getReport(){
        ...
        SUM(IF(DATE_FORMAT(tgl_keluar,'%m')='01' && (id_keadaan_keluar=5 || id_keadaan_keluar=2),1,0)) AS 'M01',
        SUM(IF(DATE_FORMAT(tgl_keluar,'%m')='02' && (id_keadaan_keluar=5 || id_keadaan_keluar=2),1,0)) AS 'M02',
        SUM(IF(DATE_FORMAT(tgl_keluar,'%m')='03' && (id_keadaan_keluar=5 || id_keadaan_keluar=2),1,0)) AS 'M03',
        SUM(IF(DATE_FORMAT(tgl_keluar,'%m')='04' && (id_keadaan_keluar=5 || id_keadaan_keluar=2),1,0)) AS 'M04',
        SUM(IF(DATE_FORMAT(tgl_keluar,'%m')='05' && (id_keadaan_keluar=5 || id_keadaan_keluar=2),1,0)) AS 'M05',
        SUM(IF(DATE_FORMAT(tgl_keluar,'%m')='06' && (id_keadaan_keluar=5 || id_keadaan_keluar=2),1,0)) AS 'M06',
        SUM(IF(DATE_FORMAT(tgl_keluar,'%m')='07' && (id_keadaan_keluar=5 || id_keadaan_keluar=2),1,0)) AS 'M07',
        SUM(IF(DATE_FORMAT(tgl_keluar,'%m')='08' && (id_keadaan_keluar=5 || id_keadaan_keluar=2),1,0)) AS 'M08',
        SUM(IF(DATE_FORMAT(tgl_keluar,'%m')='09' && (id_keadaan_keluar=5 || id_keadaan_keluar=2),1,0)) AS 'M09',
        SUM(IF(DATE_FORMAT(tgl_keluar,'%m')='10' && (id_keadaan_keluar=5 || id_keadaan_keluar=2),1,0)) AS 'M10',
        SUM(IF(DATE_FORMAT(tgl_keluar,'%m')='11' && (id_keadaan_keluar=5 || id_keadaan_keluar=2),1,0)) AS 'M11',
        SUM(IF(DATE_FORMAT(tgl_keluar,'%m')='12' && (id_keadaan_keluar=5 || id_keadaan_keluar=2),1,0)) AS 'M12'
        ...
        $x['ranap'] = $ranap;
        $this->load->view('sirs/ranap/gdr/getdata',$x);
    }
    function cetak(){
        ...
        if ($cek->num_rows() > 0) {
            $x['SQL'] = $cek;
            $this->load->view('sirs/ranap/gdr/print',$x);
        }else{
    ...
    function getdata(){
        ...
        $x['ranap'] = $ranap;
        $x['SQL'] = $this->db->query("$SQL");
        $this->load->view('sirs/ranap/gdr/getitem',$x);        
    }
}
?>