...
class pasien_masuk extends CI_Controller{
    ...
    function index(){
        ...
        if($ses_state){
            ...
            $y['index_menu'] = 8;
            $y['contentTitle'] = "SIRS - [Pasien Masuk]";        
            $y['contentTitle'] .= "<br/>Jns. Layanan : RANAP";        
            $x['content'] = $this->load->view('sirs/ranap/pasien_masuk/template_form',$y,true);
    ...
    function getReport(){
        ...
        $this->load->view('sirs/ranap/pasien_masuk/getdata',$x);
    }
    function cetak(){
        ...
        if ($cek->num_rows() > 0) {
            $x['SQL'] = $cek;
            $this->load->view('sirs/ranap/pasien_masuk/print',$x);
        }else{
    ...
    function getdata(){
        ...
        $x['SQL'] = $this->db->query("$SQL");
        $this->load->view('sirs/ranap/pasien_masuk/getitem',$x);        
    }
}
?>